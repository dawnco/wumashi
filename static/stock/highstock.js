...
(function() {
    ...
    function H(a, b, c) {
        var d, e;
        if (ma(b))
            x(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b));
        else if (x(b) &&
                da(b))
            for (d in b)
    ...
    function aa(a, b, c, d, e) {
        a = G.createElement(a);
        b && z(a, b);
        e && M(a, {padding: 0, border: ba, margin: 0});
        c && M(a, c);
        d && d.appendChild(a);
        return a
    }
    ...
    function Wa(a, b, c, d) {
        var e = K.lang, f = b === -1 ? ((a || 0).toString().split(".")[1] || "").length : isNaN(b = T(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(A(a = T(+a || 0).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
        ...
        for (var c = "{", d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1; ) {
            ...
            if (d) {
                ...
                for (h = 0; h < i; h++)
                    e = e[g[h]];
                if (f.length)
                    f = f.join(":"), g = /\.([0-9])/, h = K.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e = Wa(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : "")) : e = xa(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    function yb(a, b) {
        var c = b || [[jb, [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], [db, [1, 2, 5, 10, 15, 30]], [Ya, [1, 2, 5, 10, 15, 30]], [ya, [1, 2, 3, 4, 6, 8, 12]], [fa, [1, 2]], [Ka, [1, 2]], [La, [1, 2, 3, 4, 6]], [sa, null]], d = c[c.length - 1], e = L[d[0]], f = d[1], g;
        for (g = 0; g < c.length; g++)
            if (d = c[g], e = L[d[0]], f = d[1], c[g + 1] && a <= (e * f[f.length - 1] + L[c[g + 1][0]]) / 2)
                break;
        e === L[sa] && a < 5 * e && (f = [1, 2, 5]);
        e === L[sa] && a < 5 * e && (f = [1, 2, 5]);
        c = xb(a / e, f);
        return{unitRange: e, count: c, unitName: d[0]}
    }
    function eb(a, b, c, d) {
        var e = [], f = {}, g = K.global.useUTC, h, i = new Date(b), j = a.unitRange, k = a.count;
        if (x(b)) {
            j >= L[db] && (i.setMilliseconds(0), i.setSeconds(j >= L[Ya] ? 0 : k * V(i.getSeconds() / k)));
            if (j >= L[Ya])
                i[Lb](j >= L[ya] ? 0 : k * V(i[zb]() / k));
            if (j >= L[ya])
                i[Mb](j >= L[fa] ? 0 : k * V(i[Ab]() / k));
            if (j >= L[fa])
                i[Bb](j >= L[La] ? 1 : k * V(i[Ma]() / k));
            j >= L[La] && (i[Nb](j >= L[sa] ? 0 : k * V(i[kb]() / k)), h = i[lb]());
            j >= L[sa] && (h -= h % k, i[Ob](h));
            if (j === L[Ka])
                i[Bb](i[Ma]() -
                        i[Cb]() + p(d, 1));
            b = 1;
            h = i[lb]();
            for (var d = i.getTime(), m = i[kb](), l = i[Ma](), i = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c; )
                e.push(d), j === L[sa] ? d = mb(h + b * k, 0) : j === L[La] ? d = mb(h, m + b * k) : !g && (j === L[fa] || j === L[Ka]) ? d = mb(h, m, l + b * k * (j === L[fa] ? 1 : 7)) : (j <= L[ya] && d % L[fa] === i && (f[d] = fa), d += j * k), b++;
            e.push(d)
        }
        e.info = z(a, {higherRanks: f, totalRange: j * k});
        return e
    }
    function Pb() {
    ...
    function Rb() {
        ...
        mb = a ? Date.UTC : function(a, b, c, g, h, i) {
    ...
    var r, G = document, X = window, O = Math, v = O.round, V = O.floor, pa = O.ceil, s = O.max, C = O.min, T = O.abs, ga = O.cos, ja = O.sin, bb = O.PI, pb = bb * 2 / 360, Ra = navigator.userAgent, Tb = X.opera, Va = /msie/i.test(Ra) && !Tb, qb = G.documentMode === 8, rb = /AppleWebKit/.test(Ra), sb = /Firefox/.test(Ra), tb = /(Mobile|Android|Windows Phone)/.test(Ra), Da = "http://www.w3.org/2000/svg", ca = !!G.createElementNS && !!G.createElementNS(Da, "svg").createSVGRect, bc = sb && parseInt(Ra.split("Firefox/")[1], 10) < 4, ha = !ca && !Va &&
            !!G.createElement("canvas").getContext, cb, fb = G.documentElement.ontouchstart !== r, Ub = {}, Ib = 0, nb, K, xa, Pa, Jb, L, qa = function() {
    }, Sa = [], Oa = "div", ba = "none", Vb = "rgba(192,192,192," + (ca ? 1.0E-4 : 0.002) + ")", jb = "millisecond", db = "second", Ya = "minute", ya = "hour", fa = "day", Ka = "week", La = "month", sa = "year", Wb = "stroke-width", mb, zb, Ab, Cb, Ma, kb, lb, Lb, Mb, Bb, Nb, Ob, P = {};
    X.Highcharts = X.Highcharts ? Aa(16, !0) : {};
    xa = function(a, b, c) {
        if (!x(b) || isNaN(b))
            return"Invalid date";
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b), e, f = d[Ab](), g = d[Cb](),
                h = d[Ma](), i = d[kb](), j = d[lb](), k = K.lang, m = k.weekdays, d = z({a: m[g].substr(0, 3), A: m[g], d: Ja(h), e: h, b: k.shortMonths[i], B: k.months[i], m: Ja(i + 1), y: j.toString().substr(2, 2), Y: j, H: Ja(f), I: Ja(f % 12 || 12), l: f % 12 || 12, M: Ja(d[zb]()), p: f < 12 ? "AM" : "PM", P: f < 12 ? "am" : "pm", S: Ja(d.getSeconds()), L: Ja(v(b % 1E3), 3)}, Highcharts.dateFormats);
        for (e in d)
            for (; a.indexOf("%" + e) !== - 1; )
                a = a.replace("%" + e, typeof d[e] === "function" ? d[e](b) : d[e]);
        return c ? a.substr(0, 1).toUpperCase() + a.substr(1) : a
    };
    Pb.prototype = {wrapColor: function(a) {
            if (this.color >=
                    a)
                this.color = 0
    ...
    L = ib(jb, 1, db, 1E3, Ya, 6E4, ya, 36E5, fa, 864E5, Ka, 6048E5, La, 26784E5, sa, 31556952E3);
    Jb = {init: function(a, b, c) {
    ...
    (function(a) {
        X.HighchartsAdapter = X.HighchartsAdapter || a && {init: function(b) {
                var c = a.fx, d = c.step, e, f = a.Tween, g = f && f.propHooks;
                a.extend(a.easing, {easeOutQuad: function(a,
                            b, c, d, e) {
                        return-d * (b /= e) * (b - 2) + c
                    }});
                a.each(["cur", "_default", "width", "height", "opacity"], function(a, b) {
                    ...
                    (k = e[b]) && (e[b] = function(c) {
                        c = a ? c : this;
                        m = c.elem;
                        return m.attr ? m.attr(c.prop, b === "cur" ? r : c.now) : k.apply(this, arguments)
                    })
                });
                e = function(a) {
                    var c = a.elem, d;
                ...
                a.fn.highcharts = function() {
                    ...
                    c === r && (d = Sa[H(this[0], "data-highcharts-chart")]);
                    return d
                }
    ...
    var Q = X.HighchartsAdapter, F = Q || {};
    Q && Q.init.call(Q,
            Jb);
    var ub = F.adapterRun, cc = F.getScript, ua = F.inArray, n = F.each, Xb = F.grep, dc = F.offset, Ea = F.map, I = F.addEvent, W = F.removeEvent, D = F.fireEvent, Yb = F.washMouseEvent, Kb = F.animate, gb = F.stop, F = {enabled: !0, align: "center", x: 0, y: 15, style: {color: "#666", cursor: "default", fontSize: "11px", lineHeight: "14px"}};
    K = {colors: "#2f7ed8,#0d233a,#8bbc21,#910000,#1aadce,#492970,#f28f43,#77a1e5,#c42525,#a6c96a".split(","), symbols: ["circle", "diamond", "square", "triangle", "triangle-down"], lang: {loading: "Loading...", months: "January,February,March,April,May,June,July,August,September,October,November,December".split(","),
        ...
        plotOptions: {line: {allowPointSelect: !1, showCheckbox: !1, animation: {duration: 1E3}, events: {}, lineWidth: 2, marker: {enabled: !0, lineWidth: 0, radius: 4, lineColor: "#FFFFFF", states: {hover: {enabled: !0}, select: {fillColor: "#FFFFFF", lineColor: "#000000", lineWidth: 2}}}, point: {events: {}}, dataLabels: w(F, {enabled: !1, formatter: function() {
                        return this.y
                    }, verticalAlign: "bottom", y: 0}), cropThreshold: 300, pointRange: 0, showInLegend: !0, states: {hover: {marker: {}}, select: {marker: {}}}, stickyTracking: !0}}, labels: {style: {position: "absolute",
                color: "#3E576F"}}, legend: {enabled: !0, align: "center", layout: "horizontal", labelFormatter: function() {
                return this.name
    ...
    var R = K.plotOptions, Q = R.line;
    Rb();
    var va = function(a) {
        var b = [], c, d;
        (function(a) {
            a && a.stops ? d = Ea(a.stops,
                    function(a) {
                        return va(a[1])
        ...
        return{get: function(c) {
                var f;
                d ? (f = w(a), f.stops = [].concat(f.stops), n(d, function(a, b) {
                ...
                if (d)
                    ...
                    var c;
                    for (c = 0; c < 3; c++)
                        b[c] += A(a * 255), b[c] < 0 && (b[c] = 0), b[c] > 255 && (b[c] = 255)
                }
                return this
    ...
    Ba.prototype = {init: function(a, b) {
            this.element = b === "span" ? aa(b) : G.createElementNS(Da, b);
            this.renderer = a;
            this.attrSetters = {}
            ...
            ma(a) && x(b) && (c = a, a = {}, a[c] = b);
            if (ma(a))
                c = a, h === "circle" ? c = {x: "cx", y: "cy"}[c] || c : c === "strokeWidth" && (c = "stroke-width"), q = H(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && (q = parseFloat(q));
            else {
                for (c in a)
                    if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                        ...
                        if (c === "d")
                            ...
                            c = "text-anchor", d = {left: "start", center: "middle",
                                right: "end"}[d];
                        else if (c === "title")
                            e = g.getElementsByTagName("title")[0], e || (e = G.createElementNS(Da, "title"), g.appendChild(e)), e.textContent = d;
                        c === "strokeWidth" && (c = "stroke-width");
                        if (c === "stroke-width" || c === "stroke") {
                            this[c] = d;
                            if (this.stroke && this["stroke-width"])
                                H(g, "stroke", this.stroke), H(g, "stroke-width", this["stroke-width"]), this.hasStroke = !0;
                        ...
                        if (m && /^(width|height|visibility|x|y|d|transform)$/.test(c))
                            for (e = m.length; e--; )
                                H(m[e], c, c === "height" ? s(d - (m[e].cutHeight || 0), 0) : d);
            ...
            H(this.element, "class", H(this.element, "class") + " " + a);
            return this
        ...
        css: function(a) {
            ...
            ha && b && delete a.width;
            if (Va && !ca)
                b && delete a.width, M(this.element, a);
            else {
                for (c in a)
            ...
            if (this.added) {
                ...
                if (c || d)
                    M(b, {marginLeft: c, marginTop: d}), j && n(j, function(a) {
                ...
                if (b.tagName === "SPAN") {
                    var k, m, j = this.rotation, l, o = 0, q = 1, o = 0, N;
                    l = A(this.textWidth);
                    var u = this.xCorr || 0, t = this.yCorr || 0, y = [j, g, b.innerHTML, this.textWidth].join(",");
                    k = {};
                    if (y !== this.cTT) {
                        if (x(j))
                            a.isSVG ? (u = Va ? "-ms-transform" : rb ? "-webkit-transform" : sb ? "MozTransform" : Tb ? "-o-transform" : "", k[u] = k.transform = "rotate(" + j + "deg)") : (o = j * pb, q = ga(o), o = ja(o), k.filter = j ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", q, ", M12=", -o, ", M21=", o, ", M22=", q, ", sizingMethod='auto expand')"].join("") : ba), M(b, k);
                        k = p(this.elemWidth, b.offsetWidth);
                        m = p(this.elemHeight, b.offsetHeight);
                        if (k > l && /[ \-]/.test(b.textContent || b.innerText))
                            M(b, {width: l + "px", display: "block", whiteSpace: "normal"}), k = l;
                        ...
                        u += o * l * (N ? 1 - h : h);
                        t -= q * l * (j ? N ? h : 1 - h : 1);
                        i && (u -= k * h * (q < 0 ? -1 : 1), j && (t -= m * h * (o < 0 ? -1 : 1)), M(b, {textAlign: g}));
                        this.xCorr = u;
                        this.yCorr = t
                    }
                    M(b, {left: e + u + "px", top: f + t + "px"});
                    if (rb)
                        m = b.offsetHeight;
                    this.cTT = y
                }
            ...
            (x(c) || x(d)) && g.push("scale(" + p(c, 1) + " " + p(d, 1) + ")");
            g.length && H(this.element, "transform", g.join(" "))
        }, toFront: function() {
            var a = this.element;
            ...
            c = this.element;
            var e = this.styles, f = d * pb;
            if (!a) {
                if (c.namespaceURI === Da || b.forExport) {
                    try {
                        a = c.getBBox ? z({}, c.getBBox()) : {width: c.offsetWidth, height: c.offsetHeight}
                    } catch (g) {
                    }
                    if (!a || a.width < 0)
                        a = {width: 0, height: 0}
                ...
                if (b.isSVG) {
                    b = a.width;
                    c = a.height;
                    if (Va && e && e.fontSize === "11px" && c.toPrecision(3) === "22.7")
                        a.height = c = 14;
                    if (d)
                        a.width =
                                T(c * ja(f)) + T(b * ga(f)), a.height = T(c * ga(f)) + T(b * ja(f))
                }
                this.bBox = a
            }
            return a
            ...
            var b = this.renderer, c = a || b, d = c.element || b.box, e = d.childNodes, f = this.element, g = H(f, "zIndex"), h;
            if (a)
                this.parentGroup = a;
            ...
            if (c.handleZ)
                for (c = 0; c < e.length; c++)
                    if (a = e[c], b = H(a, "zIndex"), a !== f && (A(b) > g || !x(g) && x(b))) {
                        d.insertBefore(f, a);
                        h = !0;
                        break
                    }
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    f = g.cloneNode(0);
                    h = i * 2 + 1 - 2 * e;
                    H(f, {isShadow: "true", stroke: a.color || "black", "stroke-opacity": j * e, "stroke-width": h, transform: "translate" +
                                k, fill: ba});
                    if (c)
                        H(f, "height", s(H(f, "height") - h, 0)), f.cutHeight = h;
    ...
    Fa.prototype = {Element: Ba, init: function(a, b, c, d) {
            var e = location, f;
            f = this.createElement("svg").attr({xmlns: Da, version: "1.1"});
            a.appendChild(f.element);
            this.isSVG = !0;
            this.box = f.element;
            this.boxWrapper = f;
            this.alignedObjects = [];
            this.url = (sb || rb) && G.getElementsByTagName("base").length ? e.href.replace(/#.*?$/,
                    "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
            this.createElement("desc").add().element.appendChild(G.createTextNode("Created with Highstock 1.3.1"));
            this.defs = this.createElement("defs").add();
            this.forExport = d;
            this.gradients = {};
            this.setSize(b, c, !1);
            var g;
            if (sb && a.getBoundingClientRect)
                this.subPixelFix = b = function() {
                    M(a, {left: 0, top: 0});
                    g = a.getBoundingClientRect();
                    M(a, {left: pa(g.left) - g.left + "px", top: pa(g.top) - g.top + "px"})
                }, b(), I(X, "resize", b)
        }, isHidden: function() {
        ...
        destroy: function() {
            ...
            if (a)
                this.defs = a.destroy();
            this.subPixelFix && W(X, "resize", this.subPixelFix);
            ...
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g,
                    '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), f = b.childNodes, g = /style="([^"]+)"/, h = /href="([^"]+)"/, i = H(b, "x"), j = a.styles, k = j && j.width && A(j.width), m = j && j.lineHeight, l = f.length; l--; )
                b.removeChild(f[l]);
            ...
            n(e, function(e, f) {
                ...
                n(l, function(e) {
                    if (e !== "" || l.length === 1) {
                        var o = {},
                                n = G.createElementNS(Da, "tspan"), p;
                        g.test(e) && (p = e.match(g)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), H(n, "style", p));
                        h.test(e) && !d && (H(n, "onclick", 'location.href="' + e.match(h)[1] + '"'), M(n, {cursor: "pointer"}));
                        e = (e.replace(/<(.|\n)*?>/g, "") || " ").replace(/&lt;/g, "<").replace(/&gt;/g, ">");
                        n.appendChild(G.createTextNode(e));
                        u ? o.dx = 0 : o.x = i;
                        H(n, o);
                        !u && f && (!ca && d && M(n, {display: "block"}), H(n, "dy", m || c.fontMetrics(/px$/.test(n.style.fontSize) ? n.style.fontSize : j.fontSize).h, rb && n.offsetHeight));
                        b.appendChild(n);
                        u++;
                        if (k)
                            for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), E, B = []; e.length || B.length; )
                                delete a.bBox, E = a.getBBox().width, o = E > k, !o || e.length === 1 ? (e = B, B = [], e.length && (n = G.createElementNS(Da, "tspan"), H(n, {dy: m || 16, x: i}), p && H(n, "style", p), b.appendChild(n), E > k && (k = E))) : (n.removeChild(n.firstChild), B.unshift(e.pop())), e.length && n.appendChild(G.createTextNode(e.join(" ").replace(/- /g, "-")))
                    }
                })
            })
        }, button: function(a, b, c, d, e, f, g) {
            var h = this.label(a, b, c, null, null, null, null, null, "button"), i = 0, j, k, m, l, o, a = {x1: 0,
                y1: 0, x2: 0, y2: 1}, e = w({"stroke-width": 1, stroke: "#CCCCCC", fill: {linearGradient: a, stops: [[0, "#FEFEFE"], [1, "#F6F6F6"]]}, r: 2, padding: 5, style: {color: "black"}}, e);
            m = e.style;
            delete e.style;
            ...
            arguments.length > 1 && z(f, {x: b, y: c, width: d, height: e});
            ...
            if (h)
                g = this.path(h), z(g, {symbolName: a, x: b, y: c, width: d, height: e}), f && z(g, f);
            else if (i.test(a))
                k =
                        function(a, b) {
                            a.element && (a.attr({width: b[0], height: b[1]}), a.alignByTranslate || a.translate(v((d - b[0]) / 2), v((e - b[1]) / 2)))
                        }, j = a.match(i)[1], a = Ub[j], g = this.image(j).attr({x: b, y: c}), g.isImg = !0, a ? k(g, a) : (g.attr({width: 0, height: 0}), aa("img", {onload: function() {
            ...
            return g
                ...
                var f = e.start, c = e.r || c || d, g = e.end - 0.001, d = e.innerR, h = e.open, i = ga(f), j = ja(f), k = ga(g), g = ja(g), e = e.end - f < bb ? 0 : 1;
            ...
            if (g) {
                ...
                j = a.stops;
                b = b.radialReference;
                Ua(c) && (a[g] = c = {x1: c[0], y1: c[1], x2: c[2], y2: c[3], gradientUnits: "userSpaceOnUse"});
                g === "radialGradient" && b && !x(c.gradientUnits) && (c = w(c, {cx: b[0] - b[2] /
                ...
                for (l in j)
                    o.push(j[l]);
                o = o.join(",");
                h[o] ? a = h[o].id : (c.id = a = "highcharts-" + Ib++, h[o] = i = d.createElement(g).attr(c).add(d.defs), i.stops = [], n(j, function(a) {
                    f.test(a[1]) ? (e = va(a[1]), k = e.get("rgb"), m = e.get("a")) : (k = a[1], m = 1);
                    a = d.createElement("stop").attr({offset: a[0], "stop-color": k, "stop-opacity": m}).add(i);
                    i.stops.push(a)
                }));
                return"url(" + d.url + "#" + a + ")"
            } else
                return f.test(a) ? (e = va(a),
                        H(b, c + "-opacity", e.get("a")), e.get("rgb")) : (b.removeAttribute(c + "-opacity"), a)
        }, text: function(a, b, c, d) {
            var e = K.chart.style, f = ha || !ca && this.forExport;
            if (d && !this.forExport)
                    ...
                    if (a) {
                        if (b = a.div, !b) {
                            ...
                            n(d.reverse(), function(a) {
                                var d;
                                b = a.div = a.div || aa(Oa, {className: H(a.element, "class")}, {position: "absolute",
                                    left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px"}, b || c);
                                d = b.style;
                                z(a.attrSetters, {translateX: function(a) {
                                        d.left = a + "px"
            ...
            var a = A(a || 11), a = a < 24 ? a + 4 : v(a * 1.2), b = v(a * 0.8);
            return{h: a, b: b}
            ...
            function j() {
                ...
                p = (E === void 0 || B === void 0 || q.styles.textAlign) &&
                        N.getBBox();
                q.width = (E || p.width || 0) + 2 * ka + $;
                q.height = (B || p.height || 0) + 2 * ka;
                C = ka + o.fontMetrics(a && a.fontSize).b;
                if (A) {
                    if (!u)
                        a = v(-y * ka), b = h ? -C : 0, q.box = u = d ? o.symbol(d, a, b, q.width, q.height) : o.rect(a, b, q.width, q.height, 0, vb[Wb]), u.add(q);
                    u.isImg || u.attr(w({width: q.width, height: q.height}, vb));
                    vb = null
                }
            }
            function k() {
                var a = q.styles, a = a && a.textAlign, b = $ + ka * (1 - y), c;
                c = h ? 0 : C;
                if (x(E) && (a === "center" || a === "right"))
            ...
            function l() {
                ...
                u && x(e) && q.attr({anchorX: e, anchorY: f})
            }
            var o = this, q = o.g(i), N = o.text("", 0, 0, g).attr({zIndex: 1}), u, p, y = 0, ka = 3, $ = 0, E, B, S, s, J = 0, vb = {}, C, g = q.attrSetters, A;
            I(q, "add", l);
            g.width = function(a) {
                E = a;
                return!1
            ...
            return z(q, {css: function(a) {
                    ...
                    return{width: p.width + 2 * ka, height: p.height + 2 * ka, x: p.x - ka, y: p.y - ka}
                }, shadow: function(a) {
                    u && u.shadow(a);
                    return q
                }, destroy: function() {
    ...
    var hb, Y;
    if (!ca && !ha)
        Highcharts.VMLElement = Y = {init: function(a, b) {
                ...
                D(this, "add");
                return this
            }, updateTransform: Ba.prototype.htmlUpdateTransform, attr: function(a, b) {
                        ...
                        if (d = a[c], l = !1, e = o[c] && o[c].call(this, d, c), e !== !1 && d !== null) {
                            ...
                            if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))
                                ...
                                h === "DIV" && (d = d === "hidden" ? "-999em" : 0, qb || (g[c] =
                                        d ? "visible" : "hidden"), c = "top");
                                g[c] = d;
                                l = !0
                            } else if (c === "zIndex")
                                d && (g[c] = d), l = !0;
                            else if (ua(c, ["x", "y", "width", "height"]) !== -1)
                                this[c] = d, c === "x" || c === "y" ? c = {x: "left", y: "top"}[c] : d = s(0, d), this.updateClipping ? (this[c] = d, this.updateClipping()) : g[c] = d, l = !0;
                            else if (c === "class" && h === "DIV")
                                f.className = d;
                            else if (c === "stroke")
                                d = i.color(d, f, c), c = "strokecolor";
                            else if (c === "stroke-width" || c === "strokeWidth")
                                f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, Ia(d) && (d += "px");
                            else if (c === "dashstyle")
                                (f.getElementsByTagName("stroke")[0] ||
                                        aa(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid", this.dashstyle = d, l = !0;
                            else if (c === "fill")
                                if (h === "SPAN")
                                    g.color = d;
                                else {
                                ...
                                this[c] = d, f.style.left = -v(ja(d * pb) + 1) + "px", f.style.top = v(ga(d * pb)) + "px";
                ...
                return b.css(a)
            }, css: Ba.prototype.htmlCss, safeRemoveChild: function(a) {
                a.parentNode && Za(a)
            }, destroy: function() {
                ...
                return this
            }}, Y = ea(Ba, Y), Y = {Element: Y, isIE8: Ra.indexOf("MSIE 8.0") > -1, init: function(a, b, c) {
                var d, e;
                this.alignedObjects = [];
                ...
                this.setSize(b, c, !1);
                if (!G.namespaces.hcv)
                    G.namespaces.add("hcv", "urn:schemas-microsoft-com:vml"), G.createStyleSheet().cssText = "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } "
            }, isHidden: function() {
                return!this.box.offsetWidth
            }, clipRect: function(a, b, c, d) {
                var e = this.createElement(), f = da(a);
                return z(e, {members: [], left: f ? a.x : a, top: f ? a.y : b, width: f ? a.width : c, height: f ? a.height : d, getCSS: function(a) {
                        var b = a.element, c = b.nodeName, a = a.inverted, d = this.top -
                                (c === "shape" ? b.offsetTop : 0), e = this.left, b = e + this.width, f = d + this.height, d = {clip: "rect(" + v(a ? e : d) + "px," + v(a ? f : b) + "px," + v(a ? b : f) + "px," + v(a ? d : e) + "px)"};
                        !a && qb && c === "DIV" && z(d, {width: b + "px", height: f + "px"});
                        return d
                ...
                if (i) {
                    var k, m, l = a.linearGradient || a.radialGradient, o, q, p, u, t, y = "", a = a.stops, s, $ = [], E = function() {
                        h =
                                ['<fill colors="' + $.join(",") + '" opacity="', p, '" o:opacity2="', q, '" type="', i, '" ', y, 'focus="100%" method="any" />'];
                    ...
                    s[0] < 1 && a.push([1, s[1]]);
                    n(a, function(a, b) {
                        g.test(a[1]) ? (f = va(a[1]), k = f.get("rgb"), m = f.get("a")) : (k = a[1], m = 1);
                        $.push(a[0] * 100 + "% " + k);
                        b ? (p = m, u = k) : (q = m, t = k)
                    });
                    if (c === "fill")
                        if (i === "gradient")
                            c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, o = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, y = 'angle="' + (90 - O.atan((l - a) / (o - c)) * 180 / bb) + '"', E();
                        else {
                            var j = l.r, B = j * 2, S = j * 2, r = l.cx, x = l.cy, v = b.radialReference, w, j = function() {
                                v && (w = d.getBBox(), r += (v[0] - w.x) / w.width - 0.5, x += (v[1] - w.y) / w.height - 0.5, B *= v[2] / w.width, S *= v[2] / w.height);
                                y = 'src="' + K.global.VMLRadialGradientURL + '" size="' + B + "," + S + '" origin="0.5,0.5" position="' + r + "," + x + '" color2="' + t + '" ';
                                E()
                            };
                            d.added ? j() : I(d, "add", j);
                            j = u
                    ...
                    f = va(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], aa(this.prepVML(h), null, null, b), j = f.get("rgb");
                else {
            ...
            circle: function(a, b, c) {
                ...
                g.r = e;
                return g.attr(g.crisp(f,
                        a, b, s(c, 0), s(d, 0)))
            }, invertChild: function(a, b) {
                var c = b.style;
                M(a, {flip: "x", left: A(c.width) - 1, top: A(c.height) - 1, rotation: -90})
            }, symbols: {arc: function(a, b, c, d, e) {
                    var f = e.start, g = e.end, h = e.r || c || d, c = e.innerR, d = ga(f), i = ja(f), j = ga(g), k = ja(g);
                    if (g - f === 0)
                        return["x"];
                    ...
                    return["wa", a, b, a + c, b + d, a + c, b + d / 2, a + c, b + d / 2, "e"]
                        ...
                        b, c, d, e) {
                    var f = a + c, g = b + d, h;
                    !x(e) || !e.r ? f = Fa.prototype.symbols.square.apply(0, arguments) : (h = C(e.r, c, d), f = ["M", a + h, b, "L", f - h, b, "wa", f - 2 * h, b, f, b + 2 * h, f - h, b, f, b + h, "L", f, g - h, "wa", f - 2 * h, g - 2 * h, f, g, f, g - h, f - h, g, "L", a + h, g, "wa", a, g - 2 * h, a + 2 * h, g, a + h, g, a, g - h, "L", a, b + h, "wa", a, b, a + 2 * h, b + 2 * h, a, b + h, a + h, b, "x", "e"]);
                    return f
                }}}, Highcharts.VMLRenderer = hb = function() {
            this.init.apply(this, arguments)
        }, hb.prototype = w(Fa.prototype, Y), cb = hb;
    var Zb;
    if (ha)
        Highcharts.CanVGRenderer = Y = function() {
            Da = "http://www.w3.org/1999/xhtml"
        },
                Y.prototype.symbols = {}, Zb = function() {
            function a() {
                var a = b.length, d;
                for (d = 0; d < a; d++)
                    b[d]();
    ...
    ab.prototype = {addLabel: function() {
            var a = this.axis, b = a.options, c = a.chart, d = a.horiz, e = a.categories, f = a.series[0] && a.series[0].names, g = this.pos, h = b.labels, i = a.tickPositions, d = d && e && !h.step && !h.staggerLines && !h.rotation && c.plotWidth / i.length || !d && (c.optionsMarginLeft || c.plotWidth / 2), j = g === i[0], k = g === i[i.length - 1], f = e ? p(e[g], f && f[g],
                    g) : g, e = this.label, i = i.info, m;
            a.isDatetimeAxis && i && (m = b.dateTimeLabelFormats[i.higherRanks[g] || i.unitName]);
            this.isFirst = j;
            this.isLast = k;
            b = a.labelFormatter.call({axis: a, chart: c, isFirst: j, isLast: k, dateTimeLabelFormat: m, value: a.isLog ? oa(la(f)) : f});
            ...
            if (x(e))
                ...
                this.label = x(b) && h.enabled ? c.renderer.text(b, 0, 0, h.useHTML).attr(d).css(g).add(a.labelGroup) : null
            }
        },
        getLabelSize: function() {
            ...
            if (f || g) {
                var k = this.getLabelSides(), m = k[0], k = k[1], e = e.plotLeft, l = e + d.len, j = (d = d.ticks[j[a + (f ? 1 : -1)]]) && d.label.xy &&
            ...
            var i = this.axis,
                    j = i.transA, k = i.reversed, i = i.staggerLines, a = a + e.x - (f && d ? f * j * (k ? -1 : 1) : 0), b = b + e.y - (f && !d ? f * j * (k ? 1 : -1) : 0);
            x(e.y) || (b += A(c.styles.lineHeight) * 0.9 - c.getBBox().height / 2);
            i && (b += g / (h || 1) % i * 16);
            return{x: a, y: b}
        }, getMarkPath: function(a, b, c, d, e, f) {
            return f.crispLine(["M", a, b, "L", a + (e ? 0 : -c), b + (e ? c : 0)], d)
        }, render: function(a, b, c) {
            var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label, j = this.pos, k = e.labels, m = this.gridLine, l = h ? h + "Grid" : "grid", o = h ? h + "Tick" : "tick", q = e[l + "LineWidth"], n = e[l +
                    "LineColor"], u = e[l + "LineDashStyle"], t = e[o + "Length"], l = e[o + "Width"] || 0, y = e[o + "Color"], s = e[o + "Position"], o = this.mark, $ = k.step, E = !0, B = d.tickmarkOffset, S = this.getPosition(g, j, B, b), x = S.x, S = S.y, v = g && x === d.pos || !g && S === d.pos + d.len ? -1 : 1, w = d.staggerLines;
            this.isActive = !0;
            if (q) {
                j = d.getPlotLinePath(j + B, q * v, b, !0);
                if (m === r) {
                ...
                if (!b && m && j)
                    m[this.isNew ? "attr" : "animate"]({d: j,
                        opacity: c})
            }
            if (l && t)
                s === "inside" && (t = -t), d.opposite && (t = -t), b = this.getMarkPath(x, S, t, l * v, g, f), o ? o.animate({d: b, opacity: c}) : this.mark = f.path(b).attr({stroke: y, "stroke-width": l, opacity: c}).add(d.axisGroup);
            if (i && !isNaN(x))
                i.xy = S = this.getLabelPosition(x, S, i, g, k, B, a, $), this.isFirst && !p(e.showFirstLabel, 1) || this.isLast && !p(e.showLastLabel, 1) ? E = !1 : !w && g && k.overflow === "justify" && !this.handleOverflow(a, S) && (E = !1), $ && a % $ && (E = !1), E && !isNaN(S.y) ? (S.opacity = c, i[this.isNew ? "attr" : "animate"](S), this.isNew = !1) :
                        i.attr("y", -9999)
        }, destroy: function() {
            za(this, this.axis)
        }};
    Db.prototype = {render: function() {
            var a = this, b = a.axis, c = b.horiz, d = (b.pointRange || 0) / 2, e = a.options, f = e.label, g = a.label, h = e.width, i = e.to, j = e.from, k = x(j) && x(i), m = e.value, l = e.dashStyle, o = a.svgElem, q = [], n, u = e.color, t = e.zIndex, y = e.events, r = b.chart.renderer;
            b.isLog && (j = ra(j), i = ra(i), m = ra(m));
            if (h) {
                if (q = b.getPlotLinePath(m, h), d = {stroke: u, "stroke-width": h}, l)
                    d.dashstyle = l
            } else if (k) {
                if (j = s(j, b.min - d), i = C(i, b.max + d), q = b.getPlotBandPath(j, i, e), d = {fill: u},
                e.borderWidth)
            ...
            if (o)
            ...
            else if (q && q.length && (a.svgElem = o = r.path(q).attr(d).add(), y))
                for (n in e = function(b) {
                    ...
                    e(n);
            if (f && x(f.text) && q && q.length && b.width > 0 && b.height > 0) {
                f = w({align: c && k && "center", x: c ? !k && 4 : 10, verticalAlign: !c && k && "middle", y: c ? k ? 16 : 10 : k ? 6 : -4, rotation: c && !k && 90}, f);
                if (!g)
                    a.label = g = r.text(f.text,
                            0, 0).attr({align: f.textAlign || f.align, rotation: f.rotation, zIndex: t}).css(f.style).add();
                b = [q[1], q[4], p(q[6], q[1])];
                q = [q[2], q[5], p(q[7], q[2])];
                c = Na(b);
                k = Na(q);
    ...
    Sb.prototype = {destroy: function() {
            ...
            this.label ? this.label.attr({text: c,
                visibility: "hidden"}) : this.label = this.axis.chart.renderer.text(c, 0, 0, b.useHTML).css(b.style).attr({align: this.textAlign, rotation: b.rotation, visibility: "hidden"}).add(a)
        }, setOffset: function(a, b) {
            var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative, g = c.translate(this.percent ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0), c = T(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {x: e ? f ? g : g - c : h, y: e ? i - h - b : f ? i - g - c : i - g, width: e ? c : b, height: e ? b : c};
            if (e = this.label)
                e.align(this.alignOptions, null, f), f = e.alignAttr,
                        e.attr({visibility: this.options.crop === !1 || d.isInsidePlot(f.x, f.y) ? ca ? "inherit" : "visible" : "hidden"})
        }};
    Ca.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b", month: "%b '%y", year: "%Y"}, endOnTick: !1, gridLineColor: "#C0C0C0", labels: F, lineColor: "#C0D0E0", lineWidth: 1, minPadding: 0.01, maxPadding: 0.01, minorGridLineColor: "#E0E0E0", minorGridLineWidth: 1, minorTickColor: "#A0A0A0", minorTickLength: 2, minorTickPosition: "outside",
            ...
            this.side = this.horiz ? this.opposite ? 0 : 2 : this.opposite ?
                    1 : 3;
            this.setOptions(b);
            ...
            ua(this, a.axes) === -1 && (a.axes.push(this), a[c ? "xAxis" : "yAxis"].push(this));
            ...
            this.options = w(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], w(K[this.isXAxis ? "xAxis" : "yAxis"], a))
        }, update: function(a, b) {
            ...
            var a = this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat, e = K.lang.numericSymbols, f = e && e.length, g, h = a.options.labels.format, a = a.isLog ? b : a.tickInterval;
            if (h)
                g = Xa(h, this);
            else if (c)
                g = b;
                ...
                for (; f-- &&
                        g === r; )
                    c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Wa(b / c, -1) + e[f]);
            g === r && (g = b >= 1E3 ? Wa(b, 0) : Wa(b, -1));
            return g
            ...
            n(a.series, function(g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    var j = g.options, k, m, l, o, q, n, u, t, y, v = j.threshold, $, E = [], B = 0;
                    a.hasVisibleSeries = !0;
                    if (a.isLog && v <= 0)
                        v = j.threshold = null;
                    if (a.isXAxis) {
                        if (j = g.xData, j.length)
                            a.dataMin = C(p(a.dataMin,
                                    j[0]), Na(j)), a.dataMax = s(p(a.dataMax, j[0]), ta(j))
                    } else {
                        var S, w, J, z = g.cropped, A = g.xAxis.getExtremes(), I = !!g.modifyValue;
                        k = j.stacking;
                        ...
                        for (h = 0; h < $; h++) {
                            ...
                            y = u[h];
                            if (k)
                                w = (S = y < v) ? l : m, J = S ? n : o, x(w[t]) ? (w[t] = oa(w[t] + y), y = [y, w[t]]) : w[t] = y, c[J] || (c[J] = {}), c[J][t] || (c[J][t] = new Sb(a, a.options.stackLabels,
                                        S, t, q, k)), c[J][t].setTotal(w[t]), c[J][t].touched = f;
                            if (y !== null && y !== r && (!a.isLog || y.length || y > 0))
                                if (I && (y = g.modifyValue(y)), g.getExtremesFromAll || z || (j[h + 1] || t) >= A.min && (j[h - 1] || t) <= A.max)
                                    if (t = y.length)
                                        for (; t--; )
                                            y[t] !== null && (E[B++] = y[t]);
                                    else
                        ...
                        if (!a.usePercentage && E.length)
                            g.dataMin = k = Na(E), g.dataMax = g = ta(E), a.dataMin = C(p(a.dataMin, k), k), a.dataMax = s(p(a.dataMax, g), g);
                        if (x(v))
                            if (a.dataMin >= v)
                                a.dataMin = v, a.ignoreMinPadding = !0;
                            else if (a.dataMax < v)
                                a.dataMax = v, a.ignoreMaxPadding = !0
                    }
                }
            });
            for (g in c)
        ...
        toValue: function(a, b) {
            ...
            if (isNaN(a))
                ...
                l = !0;
            return l && !d ? null : e.renderer.crispLine(["M", c, h, "L", i,
                j], b || 0)
            ...
            for (var d, b = oa(V(b / a) * a), c = oa(pa(c / a) * a), e = []; b <= c; ) {
                e.push(b);
                b = oa(b + a);
                if (b === d)
                    break;
            ...
            if (a >= 0.5)
                ...
                for (var f = V(b), h, i, j, k, m, e = a > 0.3 ? [1,
                    2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
                    i = e.length;
                    for (h = 0; h < i && !m; h++)
                        j = ra(la(f) * e[h]), j > b && (!d || k <= c) && g.push(k), k > c && (m = !0), k = j
                }
            else if (b = la(b), c = la(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = xb(a, null, O.pow(10, V(O.log(a) / O.LN10))), g = Ea(this.getLinearTickPositions(a, b, c), ra), !d)
            ...
            if (this.isLog) {
                ...
                d = d.concat(eb(yb(c), this.min, this.max, a.startOfWeek)), d[0] < this.min && d.shift();
            else
            ...
            if (this.isXAxis &&
                    this.minRange === r && !this.isLog)
                x(a.min) || x(a.max) ? this.minRange = null : (n(this.series, function(a) {
                    i = a.xData;
            ...
            var b = this.max -
                    this.min, c = 0, d, e = 0, f = 0, g = this.linkedParent, h = this.transA;
            if (this.isXAxis)
                g ? (e = g.minPointOffset, f = g.pointRangePadding) : n(this.series, function(a) {
                    ...
                    e = s(e, h ? 0 : g / 2);
                    f = s(f, h === "on" ? 0 : g);
                    !a.noSharedTooltip && x(m) && (d = x(d) ? C(d, m) : m)
                }), g = this.ordinalSlope ? this.ordinalSlope / d : 1, this.minPointOffset = e *= g, this.pointRangePadding = f *= g, this.pointRange = C(c, b), this.closestPointRange = d;
            if (a)
                this.oldTransA = h;
            ...
            h ? (b.linkedParent = c[g ? "xAxis" : "yAxis"][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = p(c.min, c.dataMin), b.max = p(c.max, c.dataMax), d.type !== b.linkedParent.options.type &&
                    Aa(11, 1)) : (b.min = p(b.userMin, d.min, b.dataMin), b.max = p(b.userMax, d.max, b.dataMax));
            if (e)
                !a && C(b.min, p(b.dataMin, b.min)) <= 0 && Aa(10, 1), b.min = oa(ra(b.min)), b.max = oa(ra(b.max));
            if (b.range && (b.userMin = b.min = s(b.min, b.max - b.range), b.userMax = b.max, a))
                b.range = null;
            b.beforePadding && b.beforePadding();
            b.adjustForMinRange();
            if (!q && !b.usePercentage && !h && x(b.min) && x(b.max) && (c = b.max - b.min)) {
                if (!x(d.min) && !x(b.userMin) && k && (b.dataMin < 0 || !b.ignoreMinPadding))
                    b.min -= c * k;
                if (!x(d.max) && !x(b.userMax) && j && (b.dataMax > 0 ||
                        !b.ignoreMaxPadding))
                    b.max += c * j
            }
            b.tickInterval = b.min === b.max || b.min === void 0 || b.max === void 0 ? 1 : h && !m && o === b.linkedParent.options.tickPixelInterval ? b.linkedParent.tickInterval : p(m, q ? 1 : (b.max - b.min) * o / (b.len || 1));
            ...
            if (!m && b.tickInterval < l)
                b.tickInterval = l;
            if (!f &&
                    !e && (a = O.pow(10, V(O.log(b.tickInterval) / O.LN10)), !m))
                b.tickInterval = xb(b.tickInterval, null, a, d);
            ...
            if (!i)
                i = f ? (b.getNonLinearTimeTicks || eb)(yb(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : e ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval,
            ...
            this.setMaxTicks()
                ...
                b, c, d, e) {
            var f = this, g = f.chart, c = p(c, !0), e = z(e, {min: a, max: b});
            ...
            this.allowZoomOutside || (a <= this.dataMin && (a = r), b >= this.dataMax && (b = r));
            ...
            var c = (new Db(this, a)).render(), d = this.userOptions;
            b && (d[b] = d[b] || [], d[b].push(a));
            this.plotLinesAndBands.push(c);
            return c
        }, getOffset: function() {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k = 0, m, l = 0, o = d.title, q = d.labels, N = 0, u = b.axisOffset, t = b.clipOffset,
                    y = [-1, 1, 1, -1][h], r;
            a.hasData = b = a.hasVisibleSeries || x(a.min) && x(a.max) && !!e;
            ...
            a.offset = y * p(d.offset, u[h]);
            a.axisTitleMargin = p(m, N + l + (h !== 2 && N && y * d.labels[g ? "y" : "x"]));
            u[h] =
                    s(u[h], a.axisTitleMargin + k + y * a.offset);
            t[i] = s(t[i], d.lineWidth)
            ...
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite,
                    h = this.offset, i = A(e.style.fontSize || 12), d = {low: f + (a ? 0 : d), middle: f + d / 2, high: f + (a ? d : 0)}[e.align], b = (a ? c + this.height : b) + (a ? 1 : -1) * (g ? -1 : 1) * this.axisTitleMargin + (this.side === 2 ? i : 0);
            return{x: a ? d : b + (g ? this.width : 0) + h + (e.x || 0), y: a ? b - (g ? this.height : 0) + h : d + (e.y || 0)}
        }, render: function() {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.stacks, j = a.ticks, k = a.minorTicks, m = a.alternateBands, l = d.stackLabels, o = d.alternateGridColor, q = a.tickmarkOffset, p = d.lineWidth,
                    u, t = b.hasRendered && x(a.oldMin) && !isNaN(a.oldMin);
            u = a.hasData;
            var y = a.showAxis, s, $;
            n([j, k, m], function(a) {
                for (var b in a)
            ...
            if (u || f)
                if (a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function(b) {
                    ...
                    t && k[b].isNew && k[b].render(null, !0);
                    k[b].render(null, !1, 1)
                }), g.length && (n(g.slice(1).concat([g[0]]), function(b, c) {
                    c = c === g.length - 1 ? 0 : c + 1;
                    if (!f || b >= a.min && b <= a.max)
                        j[b] || (j[b] = new ab(a, b)), t && j[b].isNew && j[b].render(c, !0), j[b].render(c, !1, 1)
                }),
                        q && a.min === 0 && (j[-1] || (j[-1] = new ab(a, -1, null, !0)), j[-1].render(-1))), o && n(g, function(b, c) {
                    if (c % 2 === 0 && b < a.max)
                        m[b] || (m[b] = new Db(a)), s = b + q, $ = g[c + 1] !== r ? g[c + 1] + q : a.max, m[b].options = {from: e ? la(s) : s, to: e ? la($) : $, color: o}, m[b].render(), m[b].isActive = !0
                }), !a._addedPlotLB)
                    n((d.plotLines || []).concat(d.plotBands || []), function(b) {
                        a.addPlotBandOrLine(b)
                    }), a._addedPlotLB = !0;
            n([j, k, m], function(a) {
                var c, d, e = [], f = Pa ? Pa.duration || 500 : 0, g = function() {
                    for (d = e.length; d--; )
            ...
            if (p)
                u = a.getLinePath(p), a.axisLine ? a.axisLine.animate({d: u}) : a.axisLine = c.path(u).attr({stroke: d.lineColor, "stroke-width": p, zIndex: 7}).add(a.axisGroup), a.axisLine[y ? "show" : "hide"]();
            if (h && y)
                h[h.isNew ? "attr" : "animate"](a.getTitlePosition()), h.isNew = !1;
            if (l && l.enabled) {
                var E, B, d = a.stackTotalGroup;
                if (!d)
                    a.stackTotalGroup = d = c.g("stack-labels").attr({visibility: "visible",
                        zIndex: 6}).add();
    ...
    Eb.prototype = {init: function(a, b) {
            ...
            z(f, {x: g ? (2 * f.x + a) / 3 : a, y: g ? (f.y + b) / 2 : b, anchorX: g ? (2 * f.anchorX + c) / 3 : c, anchorY: g ? (f.anchorY + d) / 2 : d});
            e.label.attr(f);
            if (g && (T(a - f.x) > 1 || T(b - f.y) > 1))
            ...
            this.followPointer && b &&
                    (b.chartX === r && (b = d.pointer.normalize(b)), c = [b.chartX - d.plotLeft, b.chartY - f]);
            c || (n(a, function(a) {
                i = a.series.yAxis;
                g += a.plotX;
            ...
            var d = this.chart, e = d.plotLeft, f = d.plotTop, g = d.plotWidth, h = d.plotHeight, i = p(this.options.distance, 12), j = c.plotX, c = c.plotY, d = j + e + (d.inverted ? i : -a - i), k = c - b + f +
                    15, m;
            d < 7 && (d = e + s(j, 0) + i);
            ...
            i = a.series;
            h = h || !i.isCartesian ||
                    i.tooltipOutsidePlot || c.isInsidePlot(f, g);
            j === !1 || !h ? this.hide() : (this.isHidden && (gb(d), d.attr("opacity", 1).show()), d.attr({text: j}), m = e.borderColor || a.color || i.color || "#606060", d.attr({stroke: m}), this.updatePosition({plotX: f, plotY: g}), this.isHidden = !1);
            if (l) {
                l = ia(l);
                for (d = l.length; d--; )
                    if (e = a.series[d ? "yAxis" : "xAxis"], l[d] && e)
                        if (h = d ? p(a.stackY, a.y) : a.x, e.isLog && (h = ra(h)), e = e.getPlotLinePath(h, 1), this.crosshairs[d])
                            ...
                            h = {"stroke-width": l[d].width ||
                                        1, stroke: l[d].color || "#C0C0C0", zIndex: l[d].zIndex || 2};
                            if (l[d].dashStyle)
    ...
    ob.prototype = {init: function(a, b) {
            var c = ha ? "" : b.chart.zoomType, d = a.inverted, e;
            this.options = b;
            this.chart = a;
            ...
            if (b.tooltip.enabled)
                a.tooltip = new Eb(a, b.tooltip);
            this.setDOMEvents()
        }, normalize: function(a) {
            var b, c, d, a = a || X.event;
            if (!a.target)
                a.target = a.srcElement;
            a = Yb(a);
            d = a.touches ? a.touches.item(0) : a;
            this.chartPosition = b = dc(this.chart.container);
            d.pageX === r ? (c = a.x, b = a.y) : (c = d.pageX - b.left, b = d.pageY - b.top);
            return z(a, {chartX: v(c), chartY: v(b)})
        },
            ...
            if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
                ...
                for (i = 0; i < h; i++)
                    if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints.length && (b = c[i].tooltipPoints[k], b.series))
                        b._dist = T(k - b.clientX), j = C(j, b._dist), e.push(b);
                for (h = e.length; h--; )
        ...
        reset: function(a) {
            ...
            var h = this.chart, i = a ? "x" : "y", j = a ? "X" : "Y", k = "chart" + j, m = a ? "width" : "height", l = h["plot" + (a ? "Left" : "Top")], o, q, n = 1, p = h.inverted, t = h.bounds[a ? "h" : "v"], y = b.length === 1, s = b[0][k], r = c[0][k], E = !y && b[1][k], B = !y && c[1][k], v, c = function() {
                !y && T(s - E) > 20 && (n = T(r - B) / T(s - E));
                q = (l - r) / n + s;
                o = h["plot" + (a ? "Width" : "Height")] / n
            };
            c();
            b = q;
            b < t.min ? (b = t.min, v = !0) : b + o > t.max && (b = t.max - o, v = !0);
            v ? (r -= 0.8 * (r - g[i][0]), y || (B -= 0.8 * (B - g[i][1])), c()) : g[i] = [r, B];
            p || (f[i] = q - l, f[m] =
                    o);
            f = p ? 1 / n : n;
            e[m] = o;
            ...
            d["translate" + j] = f * l + (r - f * s)
        }, pinch: function(a) {
            var b = this, c = b.chart, d = b.pinchDown, e = c.tooltip.options.followTouchMove, f = a.touches, g = f.length, h = b.lastValidTouch, i = b.zoomHor || b.pinchHor, j = b.zoomVert || b.pinchVert, k = i || j, m = b.selectionMarker, l = {}, o = {};
            ...
            if (a.type === "touchstart")
                n(f, function(a, b) {
                    ...
                    if (a.zoomEnabled) {
                        var b = c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, e = a.toPixels(a.dataMin), f = a.toPixels(a.dataMax), g = C(e, f), e = s(e, f);
                        b.min = C(a.pos, g - d);
                ...
                if (!m)
                    b.selectionMarker = m = z({destroy: qa}, c.plotBox);
                i && b.pinchTranslateDirection(!0, d, f, l, m, o, h);
                j && b.pinchTranslateDirection(!1,
                        d, f, l, m, o, h);
                b.hasPinched = k;
                b.scaleGroups(l, o);
            ...
            if (this.hasDragged > 10) {
                ...
                this.selectionMarker && e && (e = d - m, this.selectionMarker.attr({width: T(e), x: (e > 0 ? 0 : e) + m}));
                this.selectionMarker && f && (e = a - l, this.selectionMarker.attr({height: T(e), y: (e > 0 ? 0 : e) + l}));
        ...
        drop: function(a) {
                ...
                if (this.hasDragged || c)
                    n(b.axes, function(a) {
                        if (a.zoomEnabled) {
                            ...
                            !isNaN(m) && !isNaN(b) && (d[a.xOrY + "Axis"].push({axis: a, min: C(m, b), max: s(m, b)}), h = !0)
                        }
                    }), h && D(b, "selection", d, function(a) {
                        b.zoom(z(a, c ? {animation: !1} : null))
                    });
            ...
            if (b)
                M(b.container, {cursor: b._cursor}), b.cancelClick = this.hasDragged, b.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = []
            ...
            var b = this.chart, c = this.chartPosition, d = b.hoverSeries, a = Yb(a);
            c &&
                    d && d.isCartesian && !b.isInsidePlot(a.pageX - c.left - b.plotLeft, a.pageY - c.top - b.plotTop) && this.reset()
            ...
            a.cancelBubble = !0;
            if (!b.cancelClick)
                c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, z(c, {pageX: g.left + d + (f ? b.plotWidth - i : h), pageY: g.top +
                            e + (f ? b.plotHeight - h : i)}), D(c.series, "click", z(a, {point: c})), c.firePointEvent("click", a)) : (z(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && D(b, "click", a))
        ...
        setDOMEvents: function() {
            ...
            this._events = c = [[b, "onmousedown", "onContainerMouseDown"], [b, "onmousemove", "onContainerMouseMove"], [b, "onclick", "onContainerClick"], [b, "mouseleave", "onContainerMouseLeave"], [G, "mousemove", "onDocumentMouseMove"], [G, "mouseup", "onDocumentMouseUp"]];
            fb && c.push([b, "ontouchstart", "onContainerTouchStart"], [b, "ontouchmove", "onContainerTouchMove"], [G, "touchend", "onDocumentTouchEnd"]);
            n(c, function(b) {
                a["_" + b[2]] = function(c) {
                    a[b[2]](c)
                };
                b[1].indexOf("on") ===
                        0 ? b[0][b[1]] = a["_" + b[2]] : I(b[0], b[1], a["_" + b[2]])
            })
        }, destroy: function() {
            var a = this;
            n(a._events, function(b) {
                b[1].indexOf("on") === 0 ? b[0][b[1]] = null : W(b[0], b[1], a["_" + b[2]])
            });
            delete a._events;
    ...
    Fb.prototype = {init: function(a, b) {
            ...
            this.options = b;
            if (b.enabled)
                c.baseline = A(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = w(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth =
                        0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.render(), I(c.chart, "endResize", function() {
            ...
            var b = this.options, c =
                    b.symbolPadding, b = !b.rtl, d = a._legendItemPos, e = d[0], d = d[1], f = a.checkbox;
            ...
            if (b)
                c = b.translateY, n(this.allItems, function(e) {
                    var f = e.checkbox, g;
                    f && (g = c + f.y + (a || 0) + 3, M(f, {left: b.translateX + e.legendItemWidth + f.x - 20 + "px", top: g + "px", display: g > c - 6 && g < c + d - 6 ? "" : ba}))
                })
            ...
            var u;
            var b = this, c = b.chart, d = c.renderer, e = b.options, f = e.layout === "horizontal", g = e.symbolWidth, h = e.symbolPadding, i = b.itemStyle, j = b.itemHiddenStyle, k = b.padding, m = !e.rtl, l = e.width, o = e.itemMarginBottom || 0, q = b.itemMarginTop, n = b.initialItemX, p = a.legendItem, t = a.series || a, y = t.options, r = y.showCheckbox, v = e.useHTML;
            if (!p && (a.legendGroup = d.g("legend-item").attr({zIndex: 1}).add(b.scrollGroup), t.drawLegendSymbol(b, a), a.legendItem = p = d.text(e.labelFormat ? Xa(e.labelFormat, a) : e.labelFormatter.call(a),
                    m ? g + h : -h, b.baseline, v).css(w(a.visible ? i : j)).attr({align: m ? "left" : "right", zIndex: 2}).add(a.legendGroup), (v ? p : a.legendGroup).on("mouseover", function() {
                a.setState("hover");
            ...
            }), b.colorizeItem(a, a.visible), y && r))
                a.checkbox = aa("input", {type: "checkbox", checked: a.selected,
                    defaultChecked: a.selected}, e.itemCheckboxStyle, c.container), I(a.checkbox, "click", function(b) {
            ...
            f ? b.itemX +=
                    e : (b.itemY += q + g + o, b.lastLineHeight = g);
            b.offsetWidth = l || s(f ? b.itemX - n : e, b.offsetWidth)
        }, render: function() {
            ...
            n(b.series, function(a) {
                var b = a.options;
                b.showInLegend && !x(b.linkedTo) && (e = e.concat(a.legendItems || (b.legendType === "point" ? a.data : a)))
            });
            Qb(e, function(a, b) {
            ...
            if (m || l) {
                ...
                if (i) {
                    if (g > 0 && h > 0)
                        i[i.isNew ? "attr" : "animate"](i.crisp(null,
                                null, null, g, h)), i.isNew = !1
                } else
                    a.box = i = c.rect(0, 0, g, h, j.borderRadius, m || 0).attr({stroke: j.borderColor, "stroke-width": m || 0, fill: l || ba}).add(d).shadow(j.shadow), i.isNew = !0;
                i[f ? "show" : "hide"]()
            }
            a.legendWidth = g;
            a.legendHeight = h;
            ...
            f && d.align(z({width: g, height: h}, j), !0, "spacingBox");
            ...
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding,
                    g = e.maxHeight, h = this.clipRect, i = e.navigation, j = p(i.animation, !0), k = i.arrowSize || 12, m = this.nav;
            ...
            d > c && (d = c);
            if (d > 0)
                b !== r && $a(b, this.chart), this.nav.attr({translateX: i, translateY: e + 7 + this.titleHeight, visibility: "visible"}), this.up.attr({fill: d ===
                            1 ? h : g}).css({cursor: d === 1 ? "default" : "pointer"}), f.attr({text: d + "/" + this.pageCount}), this.down.attr({x: 18 + this.pager.getBBox().width, fill: d === c ? h : g}).css({cursor: d === c ? "default" : "pointer"}), e = -C(e * (d - 1), this.fullHeight - e + i) + 1, this.scrollGroup.animate({translateY: e}), f.attr({text: d + "/" + c}), this.currentPage = d, this.positionCheckboxes(e)
        }};
    Qa.prototype = {init: function(a, b) {
            ...
            this.optionsMarginTop = p(d.marginTop,
                    e[0]);
            ...
            f.xAxis = [];
            f.yAxis = [];
            f.animation = ha ? !1 : p(d.animation,
                    !0);
            f.pointCount = 0;
            f.counters = new Pb;
            f.firstRender()
            ...
            var d, e = this;
            a && (b = p(b, !0), D(e, "addSeries", {options: a}, function() {
                d = e.initSeries(a);
                e.isDirtyLegend = !0;
                b && e.redraw(c)
            }));
            ...
            new Ca(this, w(a, {index: this[b].length}));
            e[b] = ia(e[b] || {});
            e[b].push(a);
            p(c, !0) && this.redraw(d)
        },
        isInsidePlot: function(a, b, c) {
            ...
            if (!c)
                this.loadingDiv = c = aa(Oa, {className: "highcharts-loading"}, z(d.style, {zIndex: 10, display: ba}), this.container), this.loadingSpan = aa("span", null, d.labelStyle, c);
            this.loadingSpan.innerHTML = a || b.lang.loading;
            if (!this.loadingShown)
                M(c, {opacity: 0, display: "", left: this.plotLeft +
                            "px", top: this.plotTop + "px", width: this.plotWidth + "px", height: this.plotHeight + "px"}), Kb(c, {opacity: d.style.opacity}, {duration: d.showDuration || 0}), this.loadingShown = !0
            ...
            n(this.series, function(b) {
                a = a.concat(Xb(b.points || [], function(a) {
                    return a.selected
                }))
            });
            return a
        }, getSelectedSeries: function() {
            return Xb(this.series,
                    function(a) {
                        return a.selected
                    })
            ...
            b.series.length && f > C(e.dataMin, e.min) && c < s(e.dataMax, e.max) && b.setExtremes(f, c, !0, !1, {trigger: "pan"});
            this.mouseDownX = a;
            ...
            this.containerWidth = ub(b, "width");
            this.containerHeight = ub(b, "height");
            this.chartWidth = s(0, a.width || this.containerWidth || 600);
            this.chartHeight = s(0, p(a.height, this.containerHeight > 19 ? this.containerHeight : 400))
        }, cloneRenderTo: function(a) {
            var b = this.renderToClone, c = this.container;
            a ? b && (this.renderTo.appendChild(c), Za(b), delete this.renderToClone) :
                    (c && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), M(b, {position: "absolute", top: "-9999px", display: "block"}), G.body.appendChild(b), c && b.appendChild(c))
        }, getContainer: function() {
            var a, b = this.options.chart, c, d, e;
            this.renderTo = a = b.renderTo;
            e = "highcharts-" + Ib++;
            if (ma(a))
                this.renderTo = a = G.getElementById(a);
            a || Aa(13, !0);
            c = A(H(a, "data-highcharts-chart"));
            !isNaN(c) && Sa[c] && Sa[c].destroy();
            ...
            c = this.chartWidth;
            d = this.chartHeight;
            this.container = a = aa(Oa, {className: "highcharts-container" + (b.className ? " " + b.className : ""), id: e}, z({position: "relative", overflow: "hidden", width: c + "px", height: d + "px", textAlign: "left", lineHeight: "normal", zIndex: 0}, b.style), this.renderToClone || a);
            this._cursor = a.style.cursor;
            this.renderer = b.forExport ? new Fa(a, c, d, !0) : new cb(a, c, d);
            ha && this.renderer.create(this, a, c, d)
        }, getMargins: function() {
            var a = this.options.chart, b = a.spacingTop, c = a.spacingRight,
                    d = a.spacingBottom, a = a.spacingLeft, e, f = this.legend, g = this.optionsMarginTop, h = this.optionsMarginLeft, i = this.optionsMarginRight, j = this.optionsMarginBottom, k = this.options.title, m = this.options.subtitle, l = this.options.legend, o = p(l.margin, 10), q = l.x, N = l.y, u = l.align, t = l.verticalAlign;
            this.resetMargins();
            e = this.axisOffset;
            if ((this.title || this.subtitle) && !x(this.optionsMarginTop))
                if (m = s(this.title && !k.floating && !k.verticalAlign && k.y || 0, this.subtitle && !m.floating && !m.verticalAlign && m.y || 0))
                    this.plotTop = s(this.plotTop,
                            m + p(k.margin, 15) + b);
            if (f.display && !l.floating)
                if (u === "right") {
                    if (!x(i))
                        this.marginRight = s(this.marginRight, f.legendWidth - q + o + c)
                } else if (u === "left") {
                    if (!x(h))
                        this.plotLeft = s(this.plotLeft, f.legendWidth + q + o + a)
                } else if (t === "top") {
                    if (!x(g))
                        this.plotTop = s(this.plotTop, f.legendHeight + N + o + b)
                } else if (t === "bottom" && !x(j))
                    this.marginBottom = s(this.marginBottom, f.legendHeight - N + o + d);
            ...
            x(h) || (this.plotLeft += e[3]);
            x(g) || (this.plotTop += e[0]);
            x(j) || (this.marginBottom += e[2]);
            x(i) || (this.marginRight += e[1]);
            this.setChartSize()
        }, initReflow: function() {
            function a(a) {
                var g = c.width || ub(d, "width"), h = c.height || ub(d, "height"), a = a ? a.target : X;
                if (!b.hasUserSize && g && h && (a === X || a === G)) {
            ...
            if (x(a))
                d.chartWidth = e = s(0, v(a)), d.hasUserSize = !!e;
            if (x(b))
                d.chartHeight = f = s(0, v(b));
            ...
            this.plotLeft = m = v(this.plotLeft);
            this.plotTop = l = v(this.plotTop);
            this.plotWidth = o = s(0, v(d - m - this.marginRight));
            this.plotHeight = q = s(0, v(e - l - this.marginBottom));
            ...
            c = pa(s(b, k[3]) / 2);
            d = pa(s(b, k[0]) / 2);
            this.clipBox = {x: c, y: d, width: V(this.plotSizeX - s(b, k[1]) / 2 - c), height: V(this.plotSizeY - s(b, k[2]) / 2 - d)};
            ...
            var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight, e = this.chartBackground, f = this.plotBackground, g = this.plotBorder, h = this.plotBGImage, i = a.borderWidth ||
                    0, j = a.backgroundColor, k = a.plotBackgroundColor, m = a.plotBackgroundImage, l = a.plotBorderWidth || 0, o, q = this.plotLeft, n = this.plotTop, p = this.plotWidth, t = this.plotHeight, y = this.plotBox, s = this.clipRect, r = this.clipBox;
            o = i + (a.shadow ? 8 : 0);
            if (i || j)
                if (e)
            ...
            if (k)
                f ? f.animate(y) : this.plotBackground = b.rect(q, n, p, t, 0).attr({fill: k}).add().shadow(a.plotShadow);
            if (m)
                h ? h.animate(y) : this.plotBGImage = b.image(m, q, n, p, t).add();
            s ? s.animate({width: r.width, height: r.height}) : this.clipRect = b.clipRect(r);
            if (l)
                g ? g.animate(g.crisp(null, q, n, p, t)) : this.plotBorder = b.rect(q, n, p, t, 0, l).attr({stroke: a.plotBorderColor, "stroke-width": l, zIndex: 1}).add();
            this.isDirtyBox = !1
            ...
            n(["inverted", "angular", "polar"], function(g) {
                ...
                for (e = d && d.length; !f &&
                        e--; )
                    (c = P[d[e].type]) && c.prototype[g] && (f = !0);
                a[g] = f
            })
        }, render: function() {
            ...
            e.items && n(e.items, function(b) {
                var d = z(e.style, b.style), f = A(d.left) + a.plotLeft, g = A(d.top) + a.plotTop + 12;
                delete d.left;
                delete d.top;
            ...
            if (d)
                d.innerHTML = "", W(d), f && Za(d);
            for (e in a)
                delete a[e]
        }, isReadyToRender: function() {
            var a = this;
            return!ca && X == X.top && G.readyState !== "complete" || ha && !X.canvg ? (ha ? Zb.push(function() {
                a.firstRender()
            }, a.options.global.canvasToolsURL) : G.attachEvent("onreadystatechange", function() {
                G.detachEvent("onreadystatechange", a.firstRender);
                G.readyState === "complete" && a.firstRender()
            }), !1) : !0
            ...
            if (a.isReadyToRender())
                a.getContainer(), D(a, "init"), a.resetMargins(), a.setChartSize(), a.propFromSeries(), a.getAxes(), n(b.series || [], function(b) {
                    a.initSeries(b)
                        ...
                        D(a, "beforeRender"), a.pointer = new ob(a, b), a.render(), a.renderer.draw(), c && c.apply(a, [a]), n(a.callbacks, function(b) {
                    b.apply(a, [a])
                }), a.cloneRenderTo(!0), D(a, "load")
        }};
    Qa.prototype.callbacks = [];
    var Ga = function() {
    };
    Ga.prototype = {init: function(a, b, c) {
            ...
            return this
                ...
                b) {
            var c = this.series, d = c.pointValKey, a = Ga.prototype.optionsToObject.call(this, a);
            z(this, a);
            this.options = this.options ? z(this.options, a) : a;
            if (d)
                this.y = this[d];
            if (this.x === r && c)
            ...
            if (!b || ua(this, b) === -1)
                this.firePointEvent("mouseOut"), this.setState(), a.hoverPoint =
                null
            ...
            return Xa(a, {point: this, series: this.series})
        }, update: function(a, b, c) {
            var d = this, e = d.series, f = d.graphic, g, h = e.data, i = e.chart, b = p(b, !0);
            ...
            var b = this.plotX, c = this.plotY, d = this.series, e = d.options.states, f = R[d.type].marker && d.options.marker,
            ...
            if (!(a === this.state || this.selected && a !== "select" || e[a] && e[a].enabled === !1 || a && (i || g && !h.enabled))) {
                if (this.graphic)
                    e = f && this.graphic.symbolName && l[a].r, this.graphic.attr(w(l[a], e ? {x: b - e, y: c - e, width: 2 * e, height: 2 * e} : {}));
                else {
                    if (a && h)
                        e = h.radius, k = k.symbol || d.symbol, j && j.currentSymbol !== k && (j = j.destroy()), j ? j.attr({x: b - e, y: c - e}) : (d.stateMarkerGraphic = j = m.renderer.symbol(k,
    ...
    Z.prototype = {isCartesian: !0, type: "line", pointClass: Ga, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, colorCounter: 0, init: function(a, b) {
            var c, d, e = a.series;
            this.chart = a;
            this.options = b = this.setOptions(b);
            this.bindAxes();
            z(this, {name: b.name, state: "", pointAttr: {}, visible: b.visible !==
            ...
            this.linkedSeries = [];
            if (ma(c) &&
                    (c = c === ":previous" ? e[this.index - 1] : a.get(c)))
            ...
            if (!e && !a.colorByPoint)
                x(b._colorIndex) ? a = b._colorIndex : (b._colorIndex = d.color, a = d.color++), e = c[a];
            this.color = e;
            ...
            if (!this.symbol)
                x(a._symbolIndex) ? a = a._symbolIndex : (a._symbolIndex = c.symbol, a = c.symbol++),
                        this.symbol = d[a];
            ...
            var e = this.options,
                    f = this.data, g = this.graph, h = this.area, i = this.chart, j = this.xData, k = this.yData, m = this.zData, l = this.names, o = g && g.shift || 0, q = e.data;
            $a(d, i);
            if (g && c)
                g.shift = o + 1;
            if (h) {
            ...
            if (l > (d.turboThreshold || 1E3)) {
                ...
                for (i = 0; i < l; i++)
                    if (a[i] !== r && (d = {series: this}, this.pointClass.prototype.applyOptions.apply(d, [a[i]]), j[i] = d.x, k[i] = q ? this.toYData(d) : d.y, m[i] = d.z, h && d.name))
                        h[i] = d.name;
            this.requireSorting && j.length > 1 && j[1] < j[0] && Aa(15);
            ma(k[0]) && Aa(14, !0);
            this.data = [];
            this.options.data = a;
            this.xData = j;
            ...
            if (m && !this.isDirty && !i.isDirty &&
                    !this.yAxis.isDirty && !a)
                return!1;
            ...
            for (l = 0; l < g; l++)
                i = h + l, j ? m[l] = (new f).init(this, [d[l]].concat(ia(e[l]))) : (b[i] ? k = b[i] : a[i] !== r && (b[i] = k = (new f).init(this, a[i], d[l])), m[l] = k);
            if (b && (g !== (c = b.length) || j))
                for (l = 0; l < c; l++)
                    if (l === h && !j && (l += g), b[l])
                        b[l].destroyElements(), b[l].plotX = r;
            this.data = b;
            this.points = m
        }, translate: function() {
            this.processedXData ||
            ...
            for (k = 0; k < g; k++) {
                var j = f[k], l = j.x, o = j.y, q = j.low, n = e.stacks[(o < a ? "-" : "") + this.stackKey];
                if (e.isLog && o <= 0)
                    j.y = o = null;
                j.plotX = c.translate(l, 0, 0, 0, 1, m);
                if (b && this.visible && n && n[l])
                    q = n[l], n = q.total, q.cum = q = q.cum - o, o = q + o, i && (q =
                            p(a, e.min)), e.isLog && q <= 0 && (q = null), b === "percent" && (q = n ? q * 100 / n : 0, o = n ? o * 100 / n : 0), j.percentage = n ? j.y * 100 / n : 0, j.total = j.stackTotal = n, j.stackY = o;
                j.yBottom = x(q) ? e.translate(q, 0, 1, 0, 1) : null;
                h && (o = this.modifyValue(o, j));
                j.plotY = typeof o === "number" && o !== Infinity ? v(e.translate(o, 0, 1, 0, 1) * 10) / 10 : r;
                j.clientX = m ? c.translate(l, 0, 0, 0, 1) : j.plotX;
                j.negative = j.y < (a || 0);
                j.category = d && d[j.x] !== r ? d[j.x] : j.x
            }
            this.getSegments()
            ...
            if (this.options.enableMouseTracking !== !1) {
                ...
                for (g = 0; g < a; g++) {
                    f = b[g];
                    c = b[g - 1] ? d + 1 : 0;
                    for (d = b[g + 1]?s(0, V((f.clientX + (b[g + 1]?b[g + 1].clientX:e)) / 2)):e; c >= 0 && c <= d; )
                        h[c++] = f
                }
            ...
            if (e && !c)
                for (g in L)
                    if (L[g] >= d.closestPointRange) {
                        c =
                                b.dateTimeLabelFormats[g];
                        break
                    }
            e && c && Ia(a.key) && (f = f.replace("{point.key}", "{point.key:" + c + "}"));
            return Xa(f, {point: a, series: this})
            ...
            if (e && !da(e))
                e = R[b.type].animation;
            h = "_sharedClip" + e.duration + e.easing;
            if (a)
                a = c[h], e = c[h + "m"], a || (c[h] = a = d.clipRect(z(f, {width: 0})), c[h + "m"] = e = d.clipRect(-99, g ? -c.plotLeft : -c.plotTop, 99, g ? c.chartWidth : c.chartHeight)), b.group.clip(a), b.markerGroup.clip(e), b.sharedClipKey = h;
            else {
                if (a = c[h])
            ...
            if (m.enabled || this._hasPointMarkers)
                for (f = b.length; f--; )
                    if (g =
                            b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = m.enabled && i.enabled === r || i.enabled, l = c.isInsidePlot(d, e, c.inverted), a && e !== r && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = p(i.symbol, this.symbol), j = i.indexOf("url") === 0, k)
                            k.attr({visibility: l ? ca ? "inherit" : "visible" : "hidden"}).animate(z({x: d - h, y: e - h}, k.symbolName ? {width: 2 * h, height: 2 * h} : {}));
                        else {
                            if (l && (h > 0 || j))
            ...
            var a = this, b = a.options, c = R[a.type].marker ? b.marker : b, d = c.states, e = d.hover, f, g = a.color, h = {stroke: g, fill: g}, i = a.points || [], j = [], k, m = a.pointAttrToOptions, l = b.negativeColor, o;
            b.marker ? (e.radius = e.radius || c.radius + 2, e.lineWidth = e.lineWidth || c.lineWidth + 1) : e.color = e.color || va(e.color || g).brighten(e.brightness).get();
            ...
            for (g = i.length; g--; ) {
                ...
                if (f) {
                    ...
                    f = d.hover = d.hover || {};
                    if (!b.marker)
                        f.color = va(f.color || h.color).brighten(f.brightness || e.brightness).get();
                    k[""] = a.convertAttribs(z({color: h.color}, c), j[""]);
                    k.hover = a.convertAttribs(d.hover,
                            j.hover, k[""]);
                    k.select = a.convertAttribs(d.select, j.select, k[""]);
                    if (h.negative && b.marker)
            ...
            var c = this.chart, d = this.type, a = w(this.userOptions, {animation: !1, index: this.index, pointStart: this.xData[0]}, a);
            this.remove(!1);
            z(this, P[a.type || d].prototype);
            this.init(c, a);
            p(b, !0) && c.redraw(!1)
        }, destroy: function() {
            ...
            if (b.enabled || a._hasPointLabels)
                a.dlProcessOptions && a.dlProcessOptions(b), g = a.plotGroup("dataLabelsGroup", "data-labels", a.visible ? "visible" : "hidden", b.zIndex || 6), e = b, n(c, function(c) {
                    var i, j = c.dataLabel, k, m, l = c.connector, o = !0;
                    ...
                    if (j && !i)
                        ...
                        b = w(e, d);
                        k = c.getLabelConfig();
                        f = b.format ? Xa(b.format, k) : b.formatter.call(k, b);
                        b.style.color = p(b.color, b.style.color,
                                a.color, "black");
                        if (j)
                            if (x(f))
                                j.attr({text: f}), o = !1;
            ...
            var f =
                    this.chart, g = f.inverted, h = p(a.plotX, -999), a = p(a.plotY, -999), i = b.getBBox(), d = z({x: g ? f.plotWidth - a : h, y: v(g ? f.plotHeight - h : a), width: 0, height: 0}, d);
            z(c, {width: i.width, height: i.height});
            ...
            e = b.chartWidth;
            var h = b.chartHeight, i = s(e, h);
            if (d && this.graph)
                d = pa(this.yAxis.len - this.yAxis.translate(a.threshold ||
            ...
            var a = this.chart, b, c = this.options, d = c.animation && !!this.animate &&
                    a.renderer.isSVG, e = this.visible ? "visible" : "hidden", f = c.zIndex, g = this.hasRendered, h = a.seriesGroup;
            ...
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, g = f.pointer,
                    h = f.renderer, i = f.options.tooltip.snap, j = a.tracker, k = b.cursor, k = k && {cursor: k}, m = a.singlePoints, l, o = function() {
                if (f.hoverSeries !== a)
                    a.onMouseOver()
            };
            if (e && !c)
            ...
            if (j)
                j.attr({d: d});
            else if (a.tracker = j = h.path(d).attr({"class": "highcharts-tracker", "stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden",
                stroke: Vb, fill: c ? Vb : ba, "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2}).addClass("highcharts-tracker").on("mouseover", o).on("mouseout", function(a) {
    ...
    F = ea(Z);
    P.line = F;
    R.area = w(Q, {threshold: 0});
    F = ea(Z, {type: "area", getSegments: function() {
            ...
            if (this.options.stacking && !this.cropped) {
                ...
                Z.prototype.getSegments.call(this), a = this.segments;
            this.segments = a
        }, getSegmentPath: function(a) {
            var b = Z.prototype.getSegmentPath.call(this, a), c = [].concat(b), d, e = this.options;
            b.length === 3 && c.push("L", b[1], b[2]);
            if (e.stacking && !this.closedStacks)
                for (d = a.length - 1; d >= 0; d--)
                    d < a.length - 1 && e.step && c.push(a[d +
            ...
            n(d, function(d) {
                var f =
                        d[0], g = a[f];
                g ? g.animate({d: b}) : a[f] = a.chart.renderer.path(b).attr({fill: p(d[2], va(d[1]).setOpacity(c.fillOpacity || 0.75).get()), zIndex: 0}).add(a.group)
            })
    ...
    P.area = F;
    R.spline = w(Q);
    Y = ea(Z, {type: "spline", getPointSpline: function(a, b, c) {
            ...
            if (f && g) {
                ...
                i += m;
                k += m;
                i > a && i > e ? (i = s(a, e), k = 2 * e - i) : i < a && i < e && (i = C(a, e), k = 2 * e - i);
                k > g && k > e ? (k = s(g, e), i = 2 * e - k) : k < g && k < e && (k = C(g, e), i = 2 * e - k);
                b.rightContX = j;
                b.rightContY = k
            }
    ...
    P.spline = Y;
    R.areaspline = w(R.area);
    var Ta = F.prototype;
    Y = ea(Y, {type: "areaspline", closedStacks: !0, getSegmentPath: Ta.getSegmentPath, closeSegment: Ta.closeSegment,
        drawGraph: Ta.drawGraph});
    P.areaspline = Y;
    R.column = w(Q, {borderColor: "#FFFFFF", borderWidth: 1, borderRadius: 0, groupPadding: 0.2, marker: null, pointPadding: 0.1, minPointLength: 0, cropThreshold: 50, pointRange: null, states: {hover: {brightness: 0.1, shadow: !1}, select: {color: "#C0C0C0", borderColor: "#000000", shadow: !1}}, dataLabels: {align: null, verticalAlign: null, y: null}, stickyTracking: !1, threshold: 0});
    Y = ea(Z, {type: "column", tooltipOutsidePlot: !0, requireSorting: !1, pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth",
            fill: "color", r: "borderRadius"}, trackerGroups: ["group", "dataLabelsGroup"], init: function() {
            ...
            c.grouping === !1 ? i = 1 : n(b.series, function(b) {
                ...
                if (b.type === a.type && b.visible && a.options.group === c.group)
                    c.stacking ? (f = b.stackKey, g[f] === r && (g[f] = i++), h = g[f]) : c.grouping !==
                            !1 && (h = i++), b.columnIndex = h
            });
            var b = C(T(d.transA) * (d.ordinalSlope || c.pointRange || d.closestPointRange || 1), d.len), d = b * c.groupPadding, j = (b - 2 * d) / i, k = c.pointWidth, c = x(k) ? (j - k) / 2 : j * c.pointPadding, k = p(k, j - 2 * c);
            return a.columnMetrics = {width: k, offset: c + (d + ((e ? i - (a.columnIndex || 0) : a.columnIndex) || 0) * j - b / 2) * (e ? -1 : 1)}
        }, translate: function() {
            var a = this, b = a.chart, c = a.options, d = c.stacking, e = c.borderWidth, f = a.yAxis, g = a.translatedThreshold = f.getThreshold(c.threshold), h = p(c.minPointLength, 5), c = a.getColumnMetrics(),
                    i = c.width, j = pa(s(i, 1 + 2 * e)), k = c.offset;
            Z.prototype.translate.apply(a);
            n(a.points, function(c) {
                var l = C(s(-999, c.plotY), f.len + 999), o = p(c.yBottom, g), q = c.plotX + k, n = pa(C(l, o)), l = pa(s(l, o) - n), u = f.stacks[(c.y < 0 ? "-" : "") + a.stackKey];
                d && a.visible && u && u[c.x] && u[c.x].setOffset(k, j);
                T(l) < h && h && (l = h, n = T(n - g) > h ? o - h : g - (f.translate(c.y, 0, 1, 0, 1) <= g ? h : 0));
                c.barX = q;
                c.pointWidth = i;
                c.shapeType = "rect";
        ...
        }, getSymbol: qa, drawLegendSymbol: F.prototype.drawLegendSymbol,
        drawGraph: qa, drawPoints: function() {
            var a = this, b = a.options, c = a.chart.renderer, d;
            n(a.points, function(e) {
                var f = e.plotY, g = e.graphic;
                if (f !== r && !isNaN(f) && e.y !== null)
                    d = e.shapeArgs, g ? (gb(g), g.animate(w(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius);
                else if (g)
                    e.graphic = g.destroy()
            })
        }, drawTracker: function() {
            ...
            Z.prototype.alignDataLabel.call(this, a, b, c, d, e)
        }, animate: function(a) {
            var b = this.yAxis, c = this.options, d = this.chart.inverted, e = {};
            if (ca)
                a ? (e.scaleY = 0.001, a = C(b.pos +
                        b.len, s(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        }, remove: function() {
            var a = this, b = a.chart;
            b.hasRendered && n(b.series, function(b) {
                if (b.type === a.type)
    ...
    P.column = Y;
    R.bar = w(R.column);
    Ta = ea(Y, {type: "bar", inverted: !0});
    P.bar = Ta;
    R.scatter = w(Q, {lineWidth: 0, tooltip: {headerFormat: '<span style="font-size: 10px; color:{series.color}">{series.name}</span><br/>',
            pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>", followPointer: !0}, stickyTracking: !1});
    Ta = ea(Z, {type: "scatter", sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["markerGroup"], drawTracker: Y.prototype.drawTracker, setTooltipPoints: qa});
    P.scatter = Ta;
    R.pie = w(Q, {borderColor: "#FFFFFF", borderWidth: 1, center: [null, null], clip: !1, colorByPoint: !0, dataLabels: {distance: 30, enabled: !0, formatter: function() {
    ...
    Q = {type: "pie", isCartesian: !1, pointClass: ea(Ga, {init: function() {
                Ga.prototype.init.apply(this, arguments);
                var a = this, b;
                if (a.y < 0)
                    a.y = null;
                z(a, {visible: a.visible !== !1, name: p(a.name, "Slice")});
                b = function() {
                    a.slice()
                };
                I(a, "select", b);
        ...
        requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["group", "dataLabelsGroup"], pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color"}, getColor: qa, animate: function(a) {
            ...
            this.generatePoints();
            var b = 0, c = 0, d = this.options, e = d.slicedOffset, f = e + d.borderWidth, g, h, i, j = this.startAngleRad = bb / 180 * ((d.startAngle || 0) % 360 - 90), k =
                    this.points, m = 2 * bb, l = d.dataLabels.distance, o = d.ignoreHiddenPoint, q, n = k.length, p;
            if (!a)
                this.center = a = this.getCenter();
            this.getX = function(b, c) {
                i = O.asin((b - a[1]) / (a[2] / 2 + l));
                return a[0] + (c ? -1 : 1) * ga(i) * (a[2] / 2 + l)
            };
            for (q = 0; q < n; q++)
            ...
            for (q = 0; q < n; q++) {
                ...
                i = (h + g) / 2;
                i > 0.75 * m && (i -= 2 * bb);
                p.slicedTranslation = {translateX: v(ga(i) *
                            e), translateY: v(ja(i) * e)};
                g = ga(i) * a[2] / 2;
                h = ja(i) * a[2] / 2;
                ...
                p.angle = i;
                f = C(f, l / 2);
                p.labelPos = [a[0] + g + ga(i) * l, a[1] + h + ja(i) * l, a[0] + g + ga(i) * f, a[1] + h + ja(i) * f, a[0] + g, a[1] + h, l < 0 ? "center" : p.half ? "right" : "left", i];
                p.percentage = d * 100;
                p.total = b
            }
            ...
            n(a.points, function(h) {
                ...
                f && f.attr(c);
                d ? d.animate(z(g, c)) : h.graphic = d = b.arc(g).setRadialReference(a.center).attr(h.pointAttr[h.selected ? "select" : ""]).attr({"stroke-linejoin": "round"}).attr(c).add(a.group).shadow(e, f);
            ...
            var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth,
                    1), h = d.plotWidth, d = d.plotHeight, i, j, k = p(e.softConnector, !0), m = e.distance, l = a.center, o = l[2] / 2, q = l[1], r = m > 0, u, t, y, x, w = [[], []], E, B, z, A, J, C = [0, 0, 0, 0], I = function(a, b) {
                return b.y - a.y
            }, H = function(a, b) {
                a.sort(function(a, c) {
            ...
            if (e.enabled || a._hasPointLabels) {
                ...
                n(b, function(a) {
                    a.dataLabel && w[a.half].push(a)
                });
                for (A = 0; !x && b[A]; )
                    x = b[A] && b[A].dataLabel && (b[A].dataLabel.getBBox().height || 21), A++;
                for (A = 2; A--; ) {
                    var b = [], L = [], G = w[A], F =
                            G.length, D;
                    H(G, A - 0.5);
                    if (m > 0) {
                        for (J = q - o - m; J <= q + o + m; J += x)
                            b.push(J);
                        t = b.length;
                        if (F > t) {
                            c = [].concat(G);
                        ...
                        for (J = 0; J < F; J++) {
                            ...
                            var M, K;
                            for (K = 0; K < t; K++)
                                M = T(b[K] - y[1]), M < c && (c = M, D = K);
                            if (D < J && b[J] !== null)
                                D = J;
                            else
                                for (t < F - J + D && b[J] !== null && (D = t - F + J); b[D] === null; )
                                    D++;
                            L.push({i: D, y: b[D]});
                            b[D] = null
                        }
                    ...
                    for (J = 0; J < F; J++) {
                        ...
                        y = c.labelPos;
                        u = c.dataLabel;
                        z = c.visible === !1 ? "hidden" : "visible";
                        c = y[1];
                        if (m > 0) {
                            if (t = L.pop(), D = t.i, B = t.y, c > B && b[D + 1] !== null || c < B && b[D - 1] !== null)
                                B = c
                        } else
                            B = c;
                        E = e.justify ? l[0] + (A ? -1 : 1) * (o + m) : a.getX(D === 0 || D === b.length - 1 ? c : B, A);
                        u._attr = {visibility: z, align: y[6]};
                        u._pos = {x: E + e.x + ({left: f, right: -f}[y[6]] || 0), y: B + e.y - 10};
                        u.connX = E;
                        u.connY = B;
                        if (this.options.size === null)
                            t = u.width, E - t < f ? C[3] = s(v(t - E + f), C[3]) : E + t > h - f && (C[1] = s(v(E + t - h + f), C[1])), B - x / 2 < 0 ? C[0] = s(v(-B + x / 2), C[0]) : B + x / 2 > d && (C[2] = s(v(B + x / 2 - d), C[2]))
                    }
                }
                if (ta(C) === 0 || this.verifyDataLabelOverflow(C))
                    this.placeDataLabels(),
                            r && g && n(this.points, function(b) {
                        i = b.connector;
                        y = b.labelPos;
                        if ((u = b.dataLabel) && u._pos)
                            E = u.connX, B = u.connY, j = k ? ["M", E + (y[6] === "left" ? 5 : -5), B, "C", E, B, 2 * y[2] - y[4], 2 * y[3] - y[5], y[2], y[3], "L", y[4], y[5]] : ["M", E + (y[6] === "left" ? 5 : -5), B, "L", y[2], y[3], "L", y[4], y[5]], i ? (i.animate({d: j}), i.attr("visibility", z)) : b.connector = i = a.chart.renderer.path(j).attr({"stroke-width": g, stroke: e.connectorColor || b.color || "#606060", visibility: z}).add(a.group);
                        else if (i)
            ...
            d[1] !== null ? e = s(C(e, b[2] - s(a[0], a[2])), c) : (e = s(C(e, b[2] - a[0] - a[2]), c), b[1] += (a[0] - a[2]) / 2);
            ...
            n(this.points, function(a) {
                var a = a.dataLabel, b;
                if (a)
                    (b = a._pos) ? (a.attr(a._attr), a[a.moved ? "animate" : "attr"](b),
                            a.moved = !0) : a && a.attr({y: -999})
            })
        }, alignDataLabel: qa, drawTracker: Y.prototype.drawTracker, drawLegendSymbol: F.prototype.drawLegendSymbol, getSymbol: qa};
    Q = ea(Z, Q);
    P.pie = Q;
    var U = Z.prototype, ec = U.processData, fc = U.generatePoints, gc = U.destroy, hc = U.tooltipHeaderFormatter, ic = {approximation: "average", groupPixelWidth: 2, dateTimeLabelFormats: ib(jb, ["%A, %b %e, %H:%M:%S.%L", "%A, %b %e, %H:%M:%S.%L", "-%H:%M:%S.%L"], db, ["%A, %b %e, %H:%M:%S", "%A, %b %e, %H:%M:%S", "-%H:%M:%S"], Ya, ["%A, %b %e, %H:%M", "%A, %b %e, %H:%M",
            ...
            groupPixelWidth: 5}}, ac = [[jb, [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], [db, [1, 2, 5, 10, 15, 30]], [Ya, [1, 2, 5, 10, 15, 30]], [ya, [1, 2, 3, 4, 6, 8, 12]], [fa, [1]], [Ka, [1]], [La, [1, 3, 6]], [sa, null]], Ha = {sum: function(a) {
            var b = a.length, c;
            if (!b && a.hasNulls)
                c = null;
            else if (b)
    ...
    U.groupData = function(a, b, c, d) {
        var e = this.data, f = this.options.data, g = [], h = [], i = a.length, j, k, m = !!b, l = [[], [], [], []], d = typeof d === "function" ?
                d : Ha[d], o = this.pointArrayMap, q = o && o.length, n;
        for (n = 0; n <= i; n++) {
            for (; c[1] !== r && a[n] >= c[1] || n === i; )
                if (j = c.shift(), k = d.apply(0, l), k !== r && (g.push(j), h.push(k)), l[0] = [], l[1] = [], l[2] = [], l[3] = [], n === i)
                    break;
            if (n === i)
                break;
            if (o) {
    ...
    U.processData = function() {
        ...
        if (ec.apply(this, arguments) !== !1 && d) {
            ...
            if (!h.groupPixelWidth) {
                for (a = k.length; a--; )
                    k[a].xAxis === h && k[a].options.dataGrouping && (i = s(i, k[a].options.dataGrouping.groupPixelWidth));
                h.groupPixelWidth =
                i
            }
            if (j > g / i || j && c.forced) {
                ...
                g = i * (k - j) / g * a;
                h = (h.getNonLinearTimeTicks || eb)(yb(g, c.units || ac), j, k, null, d, this.closestPointRange);
                f = U.groupData.apply(this, [d, f, h, c.approximation]);
                d = f[0];
                f = f[1];
                if (c.smoothed) {
                    a = d.length - 1;
    ...
    U.tooltipHeaderFormatter = function(a) {
        var b = this.tooltipOptions, c = this.options.dataGrouping, d = b.xDateFormat, e, f = this.xAxis,
                g, h;
        if (f && f.options.type === "datetime" && c && Ia(a.key)) {
            g = this.currentDataGrouping;
            c = c.dateTimeLabelFormats;
            if (g)
                f = c[g.unitName], g.count === 1 ? d = f[0] : (d = f[1], e = f[2]);
            else if (!d)
                for (h in L)
                    if (L[h] >= f.closestPointRange) {
                        d = c[h][0];
                        break
                    }
            d = xa(d, a.key);
            e && (d += xa(e, a.key + g.totalRange - 1));
    ...
    wa(U, "setOptions", function(a, b) {
        var c = a.call(this,
                b), d = this.type, e = this.chart.options.plotOptions, f = R[d].dataGrouping;
        if ($b[d])
            f || (f = w(ic, $b[d])), c.dataGrouping = w(f, e.series && e.series.dataGrouping, e[d].dataGrouping, b.dataGrouping);
        if (this.chart.options._stock)
            this.requireSorting = !0;
        return c
    });
    R.ohlc = w(R.column, {lineWidth: 1, tooltip: {pointFormat: '<span style="color:{series.color};font-weight:bold">{series.name}</span><br/>Open: {point.open}<br/>High: {point.high}<br/>Low: {point.low}<br/>Close: {point.close}<br/>'}, states: {hover: {lineWidth: 3}}, threshold: null});
    Q = ea(P.column, {type: "ohlc", pointArrayMap: ["open", "high", "low", "close"], toYData: function(a) {
            ...
            var a = this.options, b = a.states, c = a.upColor || this.color, a = w(this.pointAttr), d = this.upColorProp, e = this.points || [], f = e.length;
            a[""][d] = c;
            a.hover[d] = b.hover.upColor || c;
            a.select[d] = b.select.upColor || c;
            for (d =
                    0; d < f; d++)
                if (c = e[d], b = d > 0 ? e[d - 1].close < c.close : c.open < c.close)
                    c.pointAttr = a
        }, translate: function() {
            var a = this.yAxis;
            ...
            n(a.points, function(k) {
                if (k.plotY !== r)
                    i = k.graphic, c = k.pointAttr[k.selected ? "selected" : ""], f = c["stroke-width"] % 2 / 2, j = v(k.plotX) + f, g = v(k.shapeArgs.width /
                            2), h = ["M", j, v(k.yBottom), "L", j, v(k.plotY)], k.open !== null && (d = v(k.plotOpen) + f, h.push("M", j, d, "L", j - g, d)), k.close !== null && (e = v(k.plotClose) + f, h.push("M", j, e, "L", j + g, e)), i ? i.animate({d: h}) : k.graphic = b.renderer.path(h).attr(c).add(a.group)
            })
        }, animate: null});
    P.ohlc = Q;
    R.candlestick = w(R.column, {lineColor: "black", lineWidth: 1, states: {hover: {lineWidth: 2}}, tooltip: R.ohlc.tooltip, threshold: null, upColor: "white"});
    Q = ea(Q, {type: "candlestick", pointAttrToOptions: {fill: "color", stroke: "lineColor", "stroke-width": "lineWidth"},
        upColorProp: "fill", drawPoints: function() {
            ...
            n(a.points, function(l) {
                j = l.graphic;
                if (l.plotY !== r)
                    c = l.pointAttr[l.selected ? "selected" : ""], h = c["stroke-width"] % 2 / 2, i = v(l.plotX) + h, d = v(l.plotOpen) + h, e = v(l.plotClose) + h, f = O.min(d, e), g = O.max(d, e), m = v(l.shapeArgs.width / 2), k = ["M", i - m, g, "L", i - m, f, "L", i + m, f, "L", i + m, g, "L", i - m, g, "M", i, g, "L", i, v(l.yBottom), "M", i, f, "L", i, v(l.plotY), "Z"], j ? j.animate({d: k}) : l.graphic = b.renderer.path(k).attr(c).add(a.group)
            })
        }});
    P.candlestick = Q;
    var wb =
            Fa.prototype.symbols;
    R.flags = w(R.column, {dataGrouping: null, fillColor: "white", lineWidth: 1, pointRange: 0, shape: "flag", stackDistance: 7, states: {hover: {lineColor: "black", fillColor: "#FCFFC5"}}, style: {fontSize: "11px", fontWeight: "bold", textAlign: "center"}, tooltip: {pointFormat: "{point.text}<br/>"}, threshold: null, y: -30});
    P.flags = ea(P.column, {type: "flags", sorted: !1, noSharedTooltip: !0, takeOrdinalPosition: !1, forceCrop: !0, init: Z.prototype.init, pointAttrToOptions: {fill: "fillColor", stroke: "color", "stroke-width": "lineWidth",
            r: "radius"}, translate: function() {
            P.column.prototype.translate.apply(this);
            var a = this.chart, b = this.points, c = b.length - 1, d, e, f = this.options.onSeries, f = (d = f && a.get(f)) && d.options.step, g = d && d.points, h = g && g.length, i = this.xAxis, j = i.getExtremes(), k, m, l;
            if (d && d.visible && h) {
                m = g[h - 1].x;
                for (b.sort(function(a, b) {
                    ...
                    if (d = b[c], k = g[h], k.x <= d.x && k.plotY !== r) {
                        if (d.x <= m)
                            d.plotY = k.plotY, k.x < d.x && !f && (l = g[h + 1]) && l.plotY !== r && (d.plotY += (d.x - k.x) / (l.x - k.x) * (l.plotY - k.plotY));
                        c--;
                        h++;
                        if (c < 0)
                            break
            ...
            for (j = b.length; j--; )
                if (k = b[j], d = k.plotX + l, a = k.stackIndex, h = k.options.shape || f.shape, e = k.plotY, e !== r && (e = k.plotY + g + l - (a !== r && a * f.stackDistance)), i = a ? r : k.plotX + l, o = a ? r : k.plotY, m = k.graphic,
                        e !== r)
                    a = k.pointAttr[k.selected ? "select" : ""], m ? m.attr({x: d, y: e, r: a.r, anchorX: i, anchorY: o}) : m = k.graphic = c.label(k.options.title || f.title || "A", d, e, h, i, o, f.useHTML).css(w(f.style, k.style)).attr(a).attr({align: h === "flag" ? "left" : "center", width: f.width, height: f.height}).add(this.group).shadow(f.shadow), i = m.box, a = i.getBBox(), k.shapeArgs = z(a, {x: d - (h === "flag" ? 0 : i.attr("width") / 2), y: e});
                else if (m)
                    k.graphic = m.destroy()
        }, drawTracker: function() {
            ...
            ca && n(this.points, function(a) {
                a.graphic &&
                        I(a.graphic.element, "mouseover", function() {
                    a.graphic.toFront()
                })
            })
        }, animate: qa});
    ...
    cb === hb && n(["flag", "circlepin", "squarepin"], function(a) {
        hb.prototype.symbols[a] = wb[a]
    });
    Q = ib("linearGradient", {x1: 0, y1: 0, x2: 0, y2: 1},
    "stops", [[0, "#FFF"], [1, "#CCC"]]);
    F = [].concat(ac);
    F[4] = [fa, [1, 2, 3, 4]];
    F[5] = [Ka, [1, 2, 3]];
    z(K, {navigator: {handles: {backgroundColor: "#FFF", borderColor: "#666"}, height: 40, margin: 10, maskFill: "rgba(255, 255, 255, 0.75)", outlineColor: "#444", outlineWidth: 1, series: {type: "areaspline", color: "#4572A7", compare: null, fillOpacity: 0.4, dataGrouping: {approximation: "average", groupPixelWidth: 2, smoothed: !0, units: F}, dataLabels: {enabled: !1}, id: "highcharts-navigator-series", lineColor: "#4572A7", lineWidth: 1, marker: {enabled: !1},
            ...
            trackBackgroundColor: ib("linearGradient", {x1: 0, y1: 0, x2: 0, y2: 1}, "stops", [[0, "#EEE"], [1, "#FFF"]]), trackBorderColor: "#CCC", trackBorderWidth: 1, liveRedraw: ca}});
    Gb.prototype = {drawHandle: function(a, b) {
            ...
            this.rendered || (f[b] = d.g().css({cursor: "e-resize"}).attr({zIndex: 4 - b}).add(), h = d.rect(-4.5, 0, 9, 16, 3, 1).attr(g).add(f[b]), e.push(h), h = d.path(["M",
                -1.5, 4, "L", -1.5, 12, "M", 0.5, 4, "L", 0.5, 12]).attr(g).add(f[b]), e.push(h));
            ...
            this.rendered || (d[a] = b.g().add(this.scrollbarGroup), g = b.rect(-0.5, -0.5, e + 1, e + 1, f.buttonBorderRadius, f.buttonBorderWidth).attr({stroke: f.buttonBorderColor,
                "stroke-width": f.buttonBorderWidth, fill: f.buttonBackgroundColor}).add(d[a]), c.push(g), g = b.path(["M", e / 2 + (a ? -1 : 1), e / 2 - 3, "L", e / 2 + (a ? -1 : 1), e / 2 + 3, e / 2 + (a ? 2 : -2), e / 2]).attr({fill: f.buttonArrowColor}).add(d[a]), c.push(g));
            a && d[a].attr({translateX: this.scrollerWidth - e})
        }, render: function(a, b, c, d) {
            var e = this.chart, f = e.renderer, g, h, i, j, k = this.scrollbarGroup, m = this.navigatorGroup, l = this.scrollbar, m = this.xAxis, o = this.scrollbarTrack, n = this.scrollbarHeight, r = this.scrollbarEnabled, u = this.navigatorOptions, t = this.scrollbarOptions,
                    y = t.minWidth, x = this.height, w = this.top, E = this.navigatorEnabled, B = u.outlineWidth, z = B / 2, D = 0, J = this.outlineHeight, I = t.barBorderRadius, G = t.barBorderWidth, F = w + z;
            if (!isNaN(a)) {
                ...
                if (m.getExtremes) {
                    var H = e.xAxis[0].getExtremes(), L = H.dataMin === null, K = m.getExtremes(), M = C(H.dataMin, K.dataMin), H = s(H.dataMax, K.dataMax);
                    !L && (M !== K.min || H !== K.max) && m.setExtremes(M, H, !0, !1)
                }
                c =
                        p(c, m.translate(a));
                d = p(d, m.translate(b));
                this.zoomedMax = a = C(A(s(c, d)), h);
                this.zoomedMin = d = this.fixedWidth ? a - this.fixedWidth : s(A(C(c, d)), 0);
                this.range = c = a - d;
                ...
                if (!this.rendered) {
                    ...
                    if (r)
                        this.scrollbarGroup = k = f.g("scrollbar").add(),
                                l = t.trackBorderWidth, this.scrollbarTrack = o = f.rect().attr({y: -l % 2 / 2, fill: t.trackBackgroundColor, stroke: t.trackBorderColor, "stroke-width": l, r: t.trackBorderRadius || 0, height: n}).add(k), this.scrollbar = l = f.rect().attr({y: -G % 2 / 2, height: n, fill: t.barBackgroundColor, stroke: t.barBorderColor, "stroke-width": G, r: I}).add(k), this.scrollbarRifles = f.path().attr({stroke: t.rifleColor, "stroke-width": 1}).add(k)
                }
                e = e.isResizing ? "animate" : "attr";
                E && (this.leftShade[e]({x: g, y: w, width: d, height: x}), this.rightShade[e]({x: g + a,
                    y: w, width: h - a, height: x}), this.outline[e]({d: ["M", i, F, "L", g + d + z, F, g + d + z, F + J - n, "M", g + a - z, F + J - n, "L", g + a - z, F, i + j, F]}), this.drawHandle(d + z, 0), this.drawHandle(a + z, 1));
                if (r)
            ...
            fb && e.push([a, "touchstart", b], [a, "touchmove", c], [document, "touchend", d]);
            n(e, function(a) {
                I.apply(null, a)
            });
            this._events = e
            ...
            this._events = r;
            this.navigatorEnabled && this.baseSeries && W(this.baseSeries,
                    "updatedData", this.updatedDataHandler)
        }, init: function() {
            var a = this, b = a.chart, c, d, e = a.scrollbarHeight, f = a.navigatorOptions, g = a.height, h = a.top, i, j, k, m = document.body.style, l, o = a.baseSeries, n;
            a.mouseDownHandler = function(d) {
                var d = b.pointer.normalize(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, i = a.scrollbarHeight, k = a.scrollerLeft, o = a.scrollerWidth, n = a.navigatorLeft, p = a.navigatorWidth, q = a.scrollbarPad, r = a.range, t = d.chartX, u = d.chartY, d = b.xAxis[0], s = tb ? 10 : 7;
                if (u > h && u < h + g + i)
                    if ((h = !a.scrollbarEnabled || u < h + g) && O.abs(t -
                            e - n) < s)
                        a.grabbedLeft = !0, a.otherHandlePos = f;
                    else if (h && O.abs(t - f - n) < s)
                        a.grabbedRight = !0, a.otherHandlePos = e;
                    else if (t > n + e - q && t < n + f + q) {
                        a.grabbedCenter = t;
                        if (b.renderer.isSVG)
                            l = m.cursor, m.cursor = "ew-resize";
                        j = t - e
                    } else if (t > k && t < k + o && (f = h ? t - n - r / 2 : t < n ? e - C(10, r) : t > k + o - i ? e + C(10, r) : t < n + e ? e - r : f, f < 0 ? f = 0 : f + r > p && (f = p - r), f !== e)) {
                        a.fixedWidth = r;
            ...
            a.mouseMoveHandler =
                    function(c) {
                        var d = a.scrollbarHeight, e = a.navigatorLeft, f = a.navigatorWidth, g = a.scrollerLeft, h = a.scrollerWidth, i = a.range;
                        if (c.pageX !== 0)
                            c = b.pointer.normalize(c), c = c.chartX, c < e ? c = e : c > g + h - d && (c = g + h - d), a.grabbedLeft ? (k = !0, a.render(0, 0, c - e, a.otherHandlePos)) : a.grabbedRight ? (k = !0, a.render(0, 0, a.otherHandlePos, c - e)) : a.grabbedCenter && (k = !0, c < j ? c = j : c > f + j - i && (c = f + j - i), a.render(0, 0, c - j, c - j + i)), k && a.scrollbarOptions.liveRedraw && setTimeout(function() {
                                a.mouseUpHandler(!1)
                            }, 0)
                    };
            a.mouseUpHandler = function(d) {
                k && b.xAxis[0].setExtremes(c.translate(a.zoomedMin,
                        !0), c.translate(a.zoomedMax, !0), !0, !1, {trigger: "navigator"});
                if (d !== !1)
                    a.grabbedLeft = a.grabbedRight = a.grabbedCenter = k = j = null, m.cursor = l || ""
            };
            a.updatedDataHandler = function() {
                ...
                j && (m = g, l = m + h);
                k && (l = d, j || (m = s(l - h, i.xData[0])));
                r && (j || k) ? c.setExtremes(m, l, !0, !1, {trigger: "updatedData"}) : (p &&
                        b.redraw(!1), a.render(s(e, g), C(f, d)))
            };
            var r = b.xAxis.length, u = b.yAxis.length;
            b.extraBottomMargin = a.outlineHeight + f.margin;
            if (a.navigatorEnabled) {
                var t = o ? o.options : {}, y = t.data, v = f.series;
                n = v.data;
                a.xAxis = c = new Ca(b, w({ordinal: o && o.xAxis.options.ordinal}, f.xAxis, {isX: !0, type: "datetime", index: r, height: g, offset: 0, offsetLeft: e, offsetRight: -e, startOnTick: !1, endOnTick: !1, minPadding: 0, maxPadding: 0, zoomEnabled: !1}));
                a.yAxis = d = new Ca(b, w(f.yAxis, {alignTicks: !1, height: g, offset: 0, index: u, zoomEnabled: !1}));
                r =
                        w(t, v, {threshold: null, clip: !1, enableMouseTracking: !1, group: "nav", padXAxis: !1, xAxis: r, yAxis: u, name: "Navigator", showInLegend: !1, isInternal: !0, visible: !0});
                r.data = n || y;
                i = b.initSeries(r);
                if (o && f.adaptToUpdatedData !== !1)
                    I(o, "updatedData", a.updatedDataHandler), o.userOptions.events = z(o.userOptions.event, {updatedData: a.updatedDataHandler})
            } else
            ...
            wa(b, "getMargins",
                    function(b) {
                        ...
                        b.call(this);
                        a.top = h = a.navigatorOptions.top || this.chartHeight - a.height - a.scrollbarHeight - this.options.chart.spacingBottom - (f.verticalAlign === "bottom" && f.enabled ? e.legendHeight + p(f.margin, 10) : 0);
                        if (c && d)
    ...
    Highcharts.Scroller = Gb;
    wa(Ca.prototype, "zoom", function(a, b, c) {
        ...
        if (this.isXAxis && (g && g.enabled || e && e.enabled))
            if (f === "x")
                ...
                d = this.previousZoom, x(b) ? this.previousZoom = [this.min, this.max] : d && (b = d[0], c = d[1], delete this.previousZoom);
        return h !== r ? h : a.call(this, b, c)
    });
    wa(Qa.prototype, "init", function(a, b, c) {
    ...
    z(K, {rangeSelector: {buttonTheme: {width: 28, height: 16, padding: 1, r: 0, stroke: "#68A", zIndex: 7}, inputPosition: {align: "right"}, labelStyle: {color: "#666"}}});
    K.lang =
            w(K.lang, {rangeSelectorZoom: "Zoom", rangeSelectorFrom: "From", rangeSelectorTo: "To"});
    Hb.prototype = {clickButton: function(a, b, c) {
            ...
            if (!(l ===
                    null || o === null || a === d.selected)) {
                if (m[j])
                    v = m[j] * k, q = s(h - v, l);
                else if (j === "month")
                    i.setMonth(i.getMonth() - k), q = s(i.getTime(), l), v = 2592E6 * k;
                else if (j === "ytd")
                    if (g) {
                        if (o === r)
                        ...
                        h = new Date(o);
                        u = h.getFullYear();
                        q = u = s(l || 0, Date.UTC(u, 0, 1));
                        h = h.getTime();
                        h = C(o || h, h)
                    } else {
                        I(e, "beforeRender", function() {
                            d.clickButton(a, b)
                        });
                        return
                    }
                else
                    j === "year" ? (i.setFullYear(i.getFullYear() - k), q = s(l, i.getTime()), v =
                            31536E6 * k) : j === "all" && g && (q = l, h = o);
                f[a] && f[a].setState(2);
                g ? g.setExtremes(q, h, p(c, 1), 0, {trigger: "rangeSelectorButton", rangeSelectorButton: b}) : (c = e.options.xAxis, c[0] = w(c[0], {range: v, min: u}));
                d.selected = a
            }
            ...
            var b = this, c = a.options.rangeSelector, d = c.buttons || [].concat(b.defaultButtons), e = b.buttons =
            [], c = c.selected, f = b.blurInputs = function() {
            ...
            a.extraTopMargin = 25;
            b.buttonOptions = d;
            I(a.container, "mousedown", f);
            I(a, "resize", f);
            c !== r && d[c] && this.clickButton(c, d[c], !1);
            I(a, "load", function() {
                I(a.xAxis[0], "afterSetExtremes", function() {
            ...
            this[a + "DateBox"].attr({text: xa(c.inputDateFormat || "%b %e, %Y", this[a + "Input"].HCTime)})
            ...
            this[a + "Label"] = j = e.label(K.lang[h ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).attr({padding: 1}).css(w(d, f.labelStyle)).add(m);
            m.offset +=
                    j.width + 5;
            this[a + "DateBox"] = k = e.label("", m.offset).attr({padding: 1, width: 90, height: 16, stroke: "silver", "stroke-width": 1}).css(w({textAlign: "center"}, d, f.inputStyle)).on("click", function() {
                b[a + "Input"].focus()
            }).add(m);
            m.offset += k.width + (h ? 10 : 0);
            this[a + "Input"] = i = aa("input", {name: a, className: "highcharts-range-selector", type: "text"}, z({position: "absolute", border: 0, width: "1px", height: "1px", padding: 0, textAlign: "center", fontSize: d.fontSize, fontFamily: d.fontFamily, top: c.plotTop + "px"}, f.inputStyle), g);
            i.onfocus =
                    function() {
                        M(this, {left: m.translateX + k.x + "px", top: m.translateY + "px", width: k.width - 2 + "px", height: k.height - 2 + "px", border: "2px solid silver"})
                    };
            i.onblur = function() {
            ...
            i.onchange = function() {
                ...
                if (!isNaN(d) && (K.global.useUTC || (d += (new Date).getTimezoneOffset() * 6E4), h && d >= e.dataMin && d <= b.maxInput.HCTime || !h && d <= e.dataMax && d >=
                        b.minInput.HCTime))
                    c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, r, r, {trigger: "rangeSelectorInput"})
            }
        }, render: function(a, b) {
            var c = this, d = c.chart, e = d.renderer, f = d.container, g = d.options, h = g.exporting && d.options.navigation.buttonOptions, i = g.rangeSelector, j = c.buttons, k = K.lang, m = c.div, m = c.inputGroup, l = i.buttonTheme, o = i.inputEnabled !== !1, p = l && l.states, r = d.plotLeft, u;
            if (!c.rendered && (c.zoomText = e.text(k.rangeSelectorZoom, r, d.plotTop - 10).css(i.labelStyle).add(), u = r + c.zoomText.getBBox().width + 5, n(c.buttonOptions,
                    function(a, b) {
            ...
            o && (f = d.plotTop - 35, m.align(z({y: f, width: m.offset, x: h && f < (h.y || 0) + h.height - g.chart.spacingTop ?
                        -40 : 0}, i.inputPosition), !0, d.spacingBox), c.setInputValue("min", a), c.setInputValue("max", b));
            c.rendered = !0
        }, destroy: function() {
            var a = this.minInput, b = this.maxInput, c = this.chart, d = this.blurInputs, e;
            W(c.container, "mousedown", d);
            W(c, "resize", d);
            za(this.buttons);
            if (a)
    ...
    Highcharts.RangeSelector = Hb;
    Qa.prototype.callbacks.push(function(a) {
        function b() {
            f = a.xAxis[0].getExtremes();
            g.render(s(f.min, f.dataMin), C(f.max, f.dataMax))
        }
        function c() {
            f = a.xAxis[0].getExtremes();
        ...
        g && (I(a.xAxis[0], "afterSetExtremes", d), wa(a, "drawChartBox", function(a) {
            var c =
                    this.isDirtyBox;
            a.call(this);
            c && b()
        }), b());
        h && (I(a.xAxis[0], "afterSetExtremes", e), I(a, "resize", c), c());
        I(a, "destroy", function() {
            g && W(a.xAxis[0], "afterSetExtremes", d);
            h && (W(a, "resize", c), W(a.xAxis[0], "afterSetExtremes", e))
        })
    });
    Highcharts.StockChart = function(a, b) {
        ...
        a.xAxis = Ea(ia(a.xAxis || {}), function(a) {
            return w({minPadding: 0, maxPadding: 0, ordinal: !0, title: {text: null}, labels: {overflow: "justify"},
                showLastLabel: !0}, a, {type: "datetime", categories: null})
        });
        a.yAxis = Ea(ia(a.yAxis || {}), function(a) {
            d = a.opposite;
            return w({labels: {align: d ? "right" : "left", x: d ? -2 : 2, y: -2}, showLastLabel: !1, title: {text: null}}, a)
        });
        a.series = null;
        a = w({chart: {panning: !0, pinchType: "x"}, navigator: {enabled: !0}, scrollbar: {enabled: !0}, rangeSelector: {enabled: !0}, title: {text: null}, tooltip: {shared: !0, crosshairs: !0}, legend: {enabled: !1}, plotOptions: {line: e, spline: e, area: e, areaspline: e, arearange: e, areasplinerange: e, column: f, columnrange: f,
                candlestick: f, ohlc: f}}, a, {_stock: !0, chart: {inverted: !1}});
        a.series = c;
        return new Qa(a, b)
    };
    wa(ob.prototype, "init", function(a, b, c) {
        var d = c.chart.pinchType || "";
        a.call(this, b, c);
        this.pinchX = this.pinchHor = d.indexOf("x") !== -1;
        this.pinchY = this.pinchVert = d.indexOf("y") !== -1
    });
    var jc = U.init, kc = U.processData, lc = Ga.prototype.tooltipFormatter;
    U.init = function() {
    ...
    U.setCompare = function(a) {
        this.modifyValue = a === "value" || a === "percent" ? function(b, c) {
            var d =
                    this.compareValue, b = a === "value" ? b - d : b = 100 * (b / d) - 100;
            if (c)
                c.change = b;
            return b
        } : null;
    ...
    Ga.prototype.tooltipFormatter = function(a) {
        a = a.replace("{point.change}", (this.change > 0 ? "+" : "") + Wa(this.change, this.series.tooltipOptions.changeDecimals || 2));
    ...
    (function() {
        ...
        U.init = function() {
            ...
            b = this.chart;
            (d = this.xAxis) && d.options.ordinal && I(this, "updatedData", function() {
            ...
            if (d && d.options.ordinal && !d.hasOrdinalExtension) {
                ...
                d.beforeSetTickPositions = function() {
                    var a, b = [], c =
                            !1, e, j = this.getExtremes(), k = j.min, j = j.max, m;
                ...
                d.lin2val = function(a, b) {
                    ...
                    if (c) {
                        ...
                        if (b)
                            a < 0 ? a = c[0] : a > k ? a = c[k] : (k = V(a), l = a - k);
                        else
                            for (; k--; )
                                if (m = d * k + e, a >= m) {
                                    d = d * (k + 1) + e;
                ...
                d.getExtendedPositions = function() {
                    ...
                    if (!e[h])
                        j = {series: [], getExtremes: function() {
                            ...
                            k.options = {dataGrouping: a ? {enabled: !0, forced: !0, approximation: "open", units: [[a.unitName, [a.count]]]} :
                                        {enabled: !1}};
                ...
                d.getNonLinearTimeTicks = function(a, b, c, e, j, k, m) {
                    var l = 0, n = 0, p, s = {}, u, t, v, w = [], z = -Number.MAX_VALUE,
                            A = d.options.tickPixelInterval;
                    if (!j || j.length === 1 || b === r)
                        return eb(a, b, c, e);
                    for (t = j.length; n < t; n++) {
                        v = n && j[n - 1] > c;
                        j[n] < b && (l = n);
                        if (n === t - 1 || j[n + 1] - j[n] > k * 5 || v) {
                            if (j[n] > z) {
                                for (p = eb(a, j[l], j[n], e); p.length && p[0] <= z; )
                                    p.shift();
                    ...
                    a = p.info;
                    if (m && a.unitRange <= L[ya]) {
                        n = w.length - 1;
                        for (l = 1; l < n; l++)
                            (new Date(w[l]))[Ma]() !== (new Date(w[l - 1]))[Ma]() && (s[w[l]] = fa, u = !0);
                        u && (s[w[0]] = fa);
                        a.higherRanks = s
                    }
                    w.info = a;
                    if (m && x(A)) {
                        var m = a = w.length, n = [], B;
                        for (u = []; m--; )
                            l =
                                    d.translate(w[m]), B && (u[m] = B - l), n[m] = B = l;
                        u.sort();
                        u = u[V(u.length / 2)];
                        u < A * 0.6 && (u = null);
                        m = w[a - 1] > c ? a - 1 : a;
                        for (B = void 0; m--; )
                            l = n[m], c = B - l, B && c < A * 0.8 && (u === null || c < u * 0.8) ? (s[w[m]] && !s[w[m + 1]] ? (c = m + 1, B = l) : c = m, w.splice(c, 1)) : B = l
                    }
                    return w
                };
                var e = b.pan;
                b.pan = function(a) {
                    ...
                    if (d.options.ordinal && d.series.length) {
                        ...
                        o = b.hoverPoints;
                        var p = d.closestPointRange, i = (i - a) / (d.translationSlope * (d.ordinalSlope || p)), r = {ordinalPositions: d.getExtendedPositions()},
                        u, p = d.lin2val, t = d.val2lin;
                        if (r.ordinalPositions) {
                            if (T(i) > 1)
                                o && n(o, function(a) {
                                    a.setState()
                                }), i < 0 ? (o = r, r = d.ordinalPositions ? d : r) : o = d.ordinalPositions ? d : r, u = r.ordinalPositions, k > u[u.length - 1] && u.push(k), o = p.apply(o, [t.apply(o, [m, !0]) + i, !0]), i = p.apply(r, [t.apply(r, [l, !0]) + i, !0]), o > C(j.dataMin, m) && i < s(k, l) && d.setExtremes(o, i, !0, !1, {trigger: "pan"}), b.mouseDownX = a, M(b.container, {cursor: "move"})
                        } else
                            h = !0
                    } else
                        h = !0;
        ...
        U.getSegments = function() {
            ...
            if (e)
                d = a.segments, n(d, function(b, g) {
                    for (var h = b.length - 1; h--; )
                        b[h + 1].x - b[h].x > a.xAxis.closestPointRange * e && d.splice(g + 1, 0, b.splice(h + 1, b.length - h))
                })
        }
    })();
    z(Highcharts, {Axis: Ca, Chart: Qa, Color: va, Legend: Fb, Pointer: ob, Point: Ga, Tick: ab, Tooltip: Eb, Renderer: cb, Series: Z, SVGElement: Ba, SVGRenderer: Fa, arrayMin: Na, arrayMax: ta, charts: Sa, dateFormat: xa, format: Xa, pathAnim: Jb, getOptions: function() {
            return K
        }, hasBidiBug: bc, isTouchDevice: tb, numberFormat: Wa, seriesTypes: P, setOptions: function(a) {
            K = w(K, a);
            Rb();
            return K
        },
...
$(document).ready(function() {
    ...
    trade_global.main_chart = new Highcharts.StockChart({
        chart: {renderTo: 'trade_chart', width: 678},
        xAxis: {type: 'datetime'},
        ...
        yAxis: [
            ...
            {labels: {style: {color: '#4572A7'}}, title: {text: '成交量 [' + coin.name + ']', style: {color: '#4572A7'}}, opposite: true}
        ],
        series: [
            {animation: false, name: '成交量 [BTC]', type: 'column', color: '#4572A7', marker: {enabled: false}, yAxis: 1, data: vols},
