...
class Upload {
    ...
    function upload($file, $lang = 'zh_CN') {
		...
		$this->translation['file_error']                  = '文件错误，请重试。';
		$this->translation['local_file_missing']          = '本地文件不存在。';
		$this->translation['local_file_not_readable']     = '本地文件不可读。';
		$this->translation['uploaded_too_big_ini']        = '文件上件出错 (上传的文件大小超过了php.ini中upload_max_filesize设置的大小)。';
		$this->translation['uploaded_too_big_html']       = '文件上件出错 (上传的文件大小超过了HTML 表单设置的大小)。';
		$this->translation['uploaded_partial']            = '文件上件出错 (上传的文件部分丢失)。';
		$this->translation['uploaded_missing']            = '文件上件出错 (上传文件丢失)。';
		$this->translation['uploaded_unknown']            = '文件上件出错 (未知错误).';
		$this->translation['try_again']                   = '文件上件出错。 请重试。';
		$this->translation['file_too_big']                = '文件太大。';
		$this->translation['no_mime']                     = '未知文件类型。';
		$this->translation['incorrect_file']              = '不正确的文件格式。';
		$this->translation['image_too_wide']              = '图片宽度太大。';
		$this->translation['image_too_narrow']            = '图片宽度太小。';
		$this->translation['image_too_high']              = '图片高度太大。';
		$this->translation['image_too_short']             = '图片高度太小。';
		$this->translation['ratio_too_high']              = '图片宽/高比率太高(图片宽度太大)。';
		$this->translation['ratio_too_low']               = '图片宽/高比率太低(图片高度太大).';
		$this->translation['too_many_pixels']             = '图片位数太高。';
		$this->translation['not_enough_pixels']           = '图片位数不够';
		$this->translation['file_not_uploaded']           = '文件未上传，不能进行处理。';
		$this->translation['already_exists']              = '%s 已经存在，请更换文件名。';
		$this->translation['temp_file_missing']           = '处理的(临时)源文件不正确，不能进行处理。';
		$this->translation['source_missing']              = '已上传的文件丢失，不能进行处理。';
		$this->translation['destination_dir']             = '目标文件目录不能被创建，不能进行处理。';
		$this->translation['destination_dir_missing']     = '目标文件目录不存在，不能进行处理。';
		$this->translation['destination_path_not_dir']    = '目录路径不是一个有效的目录，不能进行处理。';
		$this->translation['destination_dir_write']       = '不能让目标文件目录设置为可写的，不能进行处理。';
		$this->translation['destination_path_write']      = '目录路径是不可以写的，不能进行处理。';
		$this->translation['temp_file']                   = '不能创建临时文件，不能进行处理。';
		$this->translation['source_not_readable']         = '源文件不可以读，不能进行处理。';
		$this->translation['no_create_support']           = '%s 不支持创建';
		$this->translation['create_error']                = '从源文件创建 %s 图片过程中出错。';
		$this->translation['source_invalid']              = '无法读取原始图片，确认是不是正确的图片文件？';
		$this->translation['gd_missing']                  = 'GD 好像不可以使用。';
		$this->translation['watermark_no_create_support'] = '%s 创建不支持, 不能读取水印文件。';
		$this->translation['watermark_create_error']      = '%s 不支持读, 不能创建水印。';
		$this->translation['watermark_invalid']           = '未知文件格式, 无法读取水印文件。';
		$this->translation['file_create']                 = '%s 不支持创建。';
		$this->translation['no_conversion_type']          = '未定义转换类型';
		$this->translation['copy_failed']                 = '在服务器上复制文件时出错。 copy() 操作失败.';
		$this->translation['reading_failed']              = '读取过程中出错。';
